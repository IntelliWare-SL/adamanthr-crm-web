							...
							<div className="card-body">
								<article className="post">
									...
									<ul className="meta">
										...
										<li>
											<span>Last Updated:</span> April, 15, 2016
										</li>
										<li>
											<span>Comments :</span>{' '}
											<Link to="/app/administrator/knowledgebase-view">5</Link>
										</li>
										<li>
								...
								<div className="feedback">
									...
									<p>
										<Link
											to="/app/administrator/knowledgebase-view"
