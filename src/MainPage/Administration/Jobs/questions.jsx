																	...
																	<div className="row">
																		<div className="col-md-6">
																			<label className="question-radio text-secondary">
																				...
																				Inadequate screen/report design
																				facilities
																			</label>
																		</div>
																		<div className="col-md-6">
															...
															<div className="col-md-12">
																<div>
																	<h4 className="mb-4 text-dark">
																		...
																		be the BEST method for ensuring that
																		critical fields in a master record have been
																		updated properly?
																	</h4>
																	<div className="row">
																		<div className="col-md-6">
													...
													<div className="tab-pane fade in " id="step4">
														<div className="row">
															<div className="col-md-12">
																<div>
																	<h4 className="mb-4 text-dark">
																		<span>4.</span> Which of the following is
																		MOST likely to result from a business
																	...
																	<div className="row">
																		...
																		<div className="col-md-6">
																			<label className="question-radio text-secondary">
																				...
																				/>
																				<span className="checkmark" />
																				Increased information protection (IP)
																				risk will increase
																			</label>
																		</div>
																	</div>
													...
													<div className="tab-pane fade in " id="step5">
														<div className="row">
															<div className="col-md-12">
																<div>
																	<h4 className="mb-4 text-dark">
																		<span>5.</span> Which of the following
																		devices extends the network and has the
																		capacity to store frames and act as a
															...
															<div className="col-md-12">
																<div>
																	<h4 className="mb-4 text-dark">
																		...
																		processing facility having electrical
																		wiring, air conditioning and flooring, but
																		no computer or communications equipment is
																		a:
																	</h4>
																	<div className="row">
																		<div className="col-md-6">
