...
!(function (t, e) {
	...
	var i = (function () {
		...
		b = {
			...
			button: function (t, e) {
				return o(
					...
					function (t, e) {
						e &&
							e.tooltip &&
							t.attr({ title: e.tooltip, 'aria-label': e.tooltip }).tooltip({
			...
			createLayout: function (t, e) {
				var o = (
					e.airMode
						? b.airEditor([b.editingArea([b.airEditable()])])
						: b.editor([
								b.toolbar(),
								b.editingArea([b.codable(), b.editable()]),
								b.statusbar(),
						  ])
				).render();
				return (
	...
	if (F) {
		...
		P && (A = parseFloat(P[1])),
			(P = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) &&
				(A = parseFloat(P[1]));
	}
	var L = /Edge\/\d+/.test(R),
		H = !!window.CodeMirror;
	if (!H && E)
		if ('function' == typeof __webpack_require__)
			...
			if (void 0 !== require.resolve)
				...
				void 0 !== require.specified && (H = require.specified('codemirror'));
	var D =
	...
	function rt(t) {
		...
		return (
			0 === e ||
			(!j(t) && 1 === e && t.innerHTML === nt) ||
			!(!N.all(t.childNodes, j) || '' !== t.innerHTML)
		);
	}
	function st(t) {
	...
	function wt(t, e) {
		...
		return (
			ut(s, ct(r)),
			o || (st(t.node), st(s)),
			i && (rt(t.node) && Tt(t.node), rt(s)) ? (Tt(s), t.node.nextSibling) : s
		);
	}
	function xt(t, o, n) {
		...
		return e.length
			? 1 === e.length
				...
				: e.reduce(function (t, e) {
						return (
							t === o.node && (t = wt(o, n)),
							wt({ node: e, offset: t ? vt(t) : it(e) }, n)
						);
				  })
			: null;
	}
	...
	var Nt = {
		...
		splitPoint: function (t, e) {
			...
			var a =
				o && xt(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
			return (
	...
	function At(t) {
		var s = function (t, e) {
				...
				if (Nt.isText(t)) {
					...
					(o = r || t.parentNode),
						(e += N.sum(N.tail(i), Nt.nodeLength)),
						(n = !r);
				} else {
	...
	var Rt = (function () {
			function r(t, e, o, n) {
				(this.sc = t),
					...
					(this.ec = o),
					(this.eo = n),
					(this.isOnEditable = this.makeIsOn(Nt.isEditable)),
					(this.isOnList = this.makeIsOn(Nt.isList)),
					(this.isOnAnchor = this.makeIsOn(Nt.isAnchor)),
					(this.isOnCell = this.makeIsOn(Nt.isCell)),
					(this.isOnData = this.makeIsOn(Nt.isData));
			}
			return (
				(r.prototype.nativeRange = function () {
					...
					var e = At({ node: this.sc, offset: this.so });
					return (
						e.setEndPoint('EndToEnd', At({ node: this.ec, offset: this.eo })), e
					);
				}),
				...
				(r.prototype.normalize = function () {
					var t = function (t, e) {
							if (
								(Nt.isVisiblePoint(t) && !Nt.isEdgePoint(t)) ||
								(Nt.isVisiblePoint(t) && Nt.isRightEdgePoint(t) && !e) ||
								(Nt.isVisiblePoint(t) && Nt.isLeftEdgePoint(t) && e) ||
								(Nt.isVisiblePoint(t) &&
									Nt.isBlock(t.node) &&
									Nt.isEmpty(t.node))
							)
							...
							if (
								((Nt.isLeftEdgePointOf(t, o) ||
									Nt.isVoid(Nt.prevPoint(t).node)) &&
									!e) ||
								((Nt.isRightEdgePointOf(t, o) ||
									Nt.isVoid(Nt.nextPoint(t).node)) &&
									e)
							) {
							...
							return (
								(e
									? Nt.nextPointUntil(Nt.nextPoint(t), Nt.isVisiblePoint)
									: Nt.prevPointUntil(Nt.prevPoint(t), Nt.isVisiblePoint)) || t
							);
						},
				...
				(r.prototype.nodes = function (o, t) {
					...
					return (
						Nt.walkPoint(
							...
							function (t) {
								var e;
								Nt.isEditable(t.node) ||
									(i
										? (Nt.isLeftEdgePoint(t) && a.push(t.node),
										  Nt.isRightEdgePoint(t) &&
												N.contains(a, t.node) &&
												(e = t.node))
										: (e = n ? Nt.ancestor(t.node, o) : t.node),
									e && o(e) && s.push(e));
							},
							!0
						),
				...
				(r.prototype.splitText = function () {
					...
					return (
						Nt.isText(this.ec) &&
							!Nt.isEdgePoint(this.getEndPoint()) &&
							this.ec.splitText(this.eo),
						Nt.isText(this.sc) &&
							!Nt.isEdgePoint(this.getStartPoint()) &&
				...
				(r.prototype.deleteContents = function () {
					...
					return (
						k.each(e, function (t, e) {
							var o = e.parentNode;
							n.node !== o && 1 === Nt.nodeLength(o) && i.push(o),
								Nt.remove(e, !1);
						}),
				...
				(r.prototype.wrapBodyInlineWithPara = function () {
					if (Nt.isBodyContainer(this.sc) && Nt.isEmpty(this.sc))
						return (
							(this.sc.innerHTML = Nt.emptyPara),
					...
					if (Nt.isInline(e.sc)) {
						...
						(t = N.last(o)),
							Nt.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so]);
					} else t = e.sc.childNodes[0 < e.so ? e.so - 1 : 0];
					var n = Nt.listPrev(t, Nt.isParaInline).reverse();
					if (
						(n = n.concat(Nt.listNext(t.nextSibling, Nt.isParaInline))).length
					) {
				...
				(r.prototype.getWordRange = function (t) {
					...
					return (
						t &&
							(e = Nt.nextPointUntil(e, function (t) {
								return !Nt.isCharPoint(t);
							})),
				...
				(r.prototype.bookmark = function (t) {
					return {
						s: { path: Nt.makeOffsetPath(t, this.sc), offset: this.so },
						e: { path: Nt.makeOffsetPath(t, this.ec), offset: this.eo },
					};
				}),
		...
		Ft = {
			create: function (t, e, o, n) {
				...
				return i || 1 !== arguments.length
					? i
					: (i = this.createFromNode(t)).collapse(Nt.emptyPara === t.innerHTML);
			},
			createFromSelection: function () {
				...
				if (z.isW3CRangeSupport) {
					...
					var c = Et(l, !0),
						d = Et(a, !1);
					Nt.isText(c.node) &&
						Nt.isLeftEdgePoint(c) &&
						Nt.isTextNode(d.node) &&
						Nt.isRightEdgePoint(d) &&
			...
			createFromNode: function (t) {
				var e = t,
					...
					i = Nt.nodeLength(n);
				return (
					Nt.isVoid(e) && ((o = Nt.listPrev(e).length - 1), (e = e.parentNode)),
					Nt.isBR(n)
						? ((i = Nt.listPrev(n).length - 1), (n = n.parentNode))
						: Nt.isVoid(n) && ((i = Nt.listPrev(n).length), (n = n.parentNode)),
					this.create(e, o, n, i)
				);
			},
			...
			return (
				...
				(t.prototype.applySnapshot = function (t) {
					null !== t.contents && this.$editable.html(t.contents),
						null !== t.bookmark &&
							Ft.createFromBookmark(this.editable, t.bookmark).select();
				}),
		...
		Dt = (function () {
			...
			return (
				...
				(t.prototype.stylePara = function (t, o) {
					k.each(t.nodes(Nt.isPara, { includeAncestor: !0 }), function (t, e) {
						k(e).css(o);
					});
				}),
				(t.prototype.styleNodes = function (t, e) {
					...
					var r = Nt.makePredByNodeName(o),
						s = t.nodes(Nt.isText, { fullyContains: !0 }).map(function (t) {
				...
				(t.prototype.current = function (t) {
					...
					return (
						(o.anchor = t.isOnAnchor() && Nt.ancestor(t.sc, Nt.isAnchor)),
						(o.ancestors = Nt.listAncestor(t.sc, Nt.isEditable)),
						(o.range = t),
						o
					);
				}),
			...
			return (
				...
				(t.prototype.indent = function (t) {
					var i = this,
						...
						o = e.nodes(Nt.isPara, { includeAncestor: !0 }),
				...
				(t.prototype.toggleList = function (o, t) {
					var n = this,
						e = Ft.create(t).wrapBodyInlineWithPara(),
						i = e.nodes(Nt.isPara, { includeAncestor: !0 }),
						r = e.paraBookmark(i),
					...
					if (N.find(i, Nt.isPurePara)) {
						...
						var l = e
							.nodes(Nt.isList, { includeAncestor: !0 })
							.filter(function (t) {
				...
				(t.prototype.wrapList = function (t, e) {
					...
					return (
						...
						Nt.appendChildNodes(s, t),
						r && (Nt.appendChildNodes(s, N.from(r.childNodes)), Nt.remove(r)),
						t
					);
				}),
							...
							if ('LI' === i.parentNode.nodeName)
								...
								var s =
										1 < i.childNodes.length
											? Nt.splitTree(
													i,
													{ node: n.parentNode, offset: Nt.position(n) + 1 },
													{ isSkipPaddingBlankHTML: !0 }
											  )
											: null,
									a = Nt.splitTree(
										i,
										{ node: o.parentNode, offset: Nt.position(o) },
										{ isSkipPaddingBlankHTML: !0 }
									);
								(e = c
									? Nt.listDescendant(a, Nt.isLi)
									: N.from(a.childNodes).filter(Nt.isLi)),
									(!c && Nt.isList(i.parentNode)) ||
										(e = e.map(function (t) {
				...
				(t.prototype.appendToPrevious = function (t) {
					return t.previousSibling
						? Nt.appendChildNodes(t.previousSibling, [t])
						: this.wrapList([t], 'LI');
				}),
				(t.prototype.findList = function (t) {
					return t
						? N.find(t.children, function (t) {
			...
			return (
				(t.prototype.insertTab = function (t, e) {
					...
					(t = t.deleteContents()).insertNode(o, !0),
						(t = Ft.create(o, e)).select();
				}),
				(t.prototype.insertParagraph = function (t, e) {
					e = (e = (e =
						e || Ft.create(t)).deleteContents()).wrapBodyInlineWithPara();
					var o,
						n = Nt.ancestor(e.sc, Nt.isPara);
					if (n) {
						if (Nt.isEmpty(n) && Nt.isLi(n))
							return void this.bullet.toggleList(n.parentNode.nodeName);
						var i = null;
						if (
							(1 === this.options.blockquoteBreakingLevel
								? (i = Nt.ancestor(n, Nt.isBlockquote))
								: 2 === this.options.blockquoteBreakingLevel &&
								  (i = Nt.lastAncestor(n, Nt.isBlockquote)),
							i)
						) {
							(o = k(Nt.emptyPara)[0]),
								Nt.isRightEdgePoint(e.getStartPoint()) &&
									Nt.isBR(e.sc.nextSibling) &&
							...
							(s = s.concat(Nt.listDescendant(o, Nt.isEmptyAnchor))),
								k.each(s, function (t, e) {
									Nt.remove(e);
								}),
								(Nt.isHeading(o) || Nt.isPre(o) || Nt.isCustomStyleTag(o)) &&
									Nt.isEmpty(o) &&
									(o = Nt.replace(o, 'p'));
						}
					} else {
			...
			(this.getActionList = function () {
				for (
					var t,
						e,
						o,
						n = h === Mt.where.Row ? f.rowPos : -1,
						i = h === Mt.where.Column ? f.colPos : -1,
						r = 0,
						s = !0;
					s;
	...
	(Mt.where = { Row: 0, Column: 1 }),
		(Mt.requestAction = { Add: 0, Delete: 1 }),
		(Mt.resultAction = {
			Ignore: 0,
			SubtractSpanCount: 1,
			RemoveCell: 2,
				...
				(t.prototype.addCol = function (t, e) {
					...
					for (
						...
						switch (s.action) {
							case Mt.resultAction.AddCell:
								'right' === e
									? k(s.baseCell).after('<td' + a + '>' + Nt.blank + '</td>')
									: k(s.baseCell).before('<td' + a + '>' + Nt.blank + '</td>');
								break;
							case Mt.resultAction.SumSpanCount:
								if ('right' === e) {
		...
		jt = (function () {
			function t(t) {
				...
				(this.context = t),
					...
					(this.style = new Dt()),
					(this.table = new Ut()),
					(this.typing = new zt(t)),
					(this.bullet = new Bt()),
					(this.history = new Ht(this.$editable)),
				...
				(this.insertParagraph = this.wrapCommand(function () {
					...
					(this.insertNode = this.wrapCommand(function (t) {
						u.isLimited(k(t).text().length) ||
							...
							Ft.createFromNodeAfter(t).select());
					})),
			...
			return (
				(t.prototype.initialize = function () {
					...
					this.$editable
						...
						this.$editable.html(Nt.html(this.$note) || Nt.emptyPara),
						this.$editable.on(
							z.inputEventName,
							C.debounce(function () {
				...
				(t.prototype.handleKeyMap = function (t) {
					...
					i
						...
						: Lt.isEdit(t.keyCode) && this.afterCommand();
				}),
				(t.prototype.preventDefaultEditableShortCuts = function (t) {
					(t.ctrlKey || t.metaKey) &&
						N.contains([66, 73, 85], t.keyCode) &&
						t.preventDefault();
				}),
					...
					return (
						...
						(void 0 === e ||
							!(
								...
								e.ctrlKey ||
								e.metaKey ||
								N.contains([Lt.code.BACKSPACE, Lt.code.DELETE], e.keyCode)
							)) &&
					...
					k
						...
						.then(function (t) {
							n.beforeCommand(),
								...
								t.show(),
								Ft.create(n.editable).insertNode(t[0]),
								Ft.createFromNodeAfter(t[0]).select(),
								n.afterCommand();
						})
						.fail(function (t) {
				...
				(t.prototype.getSelectedText = function () {
					...
					return (
						t.isOnAnchor() &&
							(t = Ft.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))),
						t.toString()
					);
				}),
				...
				(t.prototype.fontStyling = function (t, e) {
					...
					if (o) {
						...
						if ((k(n).css(t, e), o.isCollapsed())) {
							...
							i &&
								!Nt.nodeLength(i) &&
								((i.innerHTML = Nt.ZERO_WIDTH_NBSP_CHAR),
								Ft.createFromNodeAfter(i.firstChild).select(),
				...
				(t.prototype.isEmpty = function () {
					return (
						Nt.isEmpty(this.$editable[0]) ||
						Nt.emptyPara === this.$editable.html()
					);
				}),
	...
	var Vt = (function () {
			...
			return (
				...
				(t.prototype.activate = function () {
					...
					if (
						(this.$codable.val(
							Nt.html(this.$editable, this.options.prettifyHtml)
						),
				...
				(t.prototype.deactivate = function () {
					...
					var e =
							Nt.value(this.$codable, this.options.prettifyHtml) ||
							Nt.emptyPara,
		...
		Yt = (function () {
			...
			return (
				...
				(t.prototype.handleKeyup = function (t) {
					N.contains([Lt.code.ENTER, Lt.code.SPACE], t.keyCode) &&
						this.replace();
				}),
				t
			);
		...
		Xt = (function () {
			function t(t) {
				(this.ui = k.summernote.ui),
					...
					(this.options = t.options),
					(this.lang = this.options.langInfo),
					(this.invertedKeyMap = C.invertObject(
						this.options.keyMap[z.isMac ? 'mac' : 'pc']
					));
			}
			return (
				(t.prototype.representShortcut = function (t) {
					...
					return this.options.shortcuts && e
						? (z.isMac && (e = e.replace('CMD', '⌘').replace('SHIFT', '⇧')),
						  ' (' +
								(e = e
									.replace('BACKSLASH', '\\')
									.replace('SLASH', '/')
					...
					return (
						this.fontInstalledMap.hasOwnProperty(t) ||
							(this.fontInstalledMap[t] =
								z.isFontInstalled(t) ||
								N.contains(this.options.fontNamesIgnoreCheck, t)),
						this.fontInstalledMap[t]
					);
				}),
				...
				(t.prototype.addToolbarButtons = function () {
					...
					this.context.memo('button.justifyLeft', C.invoke(r, 'render')),
						this.context.memo('button.justifyCenter', C.invoke(s, 'render')),
						this.context.memo('button.justifyRight', C.invoke(a, 'render')),
						this.context.memo('button.justifyFull', C.invoke(l, 'render')),
						this.context.memo('button.outdent', C.invoke(c, 'render')),
						this.context.memo('button.indent', C.invoke(d, 'render')),
						...
						.Deferred(function (n) {
							...
							c.ui.onDialogShown(c.$dialog, function () {
								...
								r
									...
									.val(l.url),
									z.isSupportTouch || r.trigger('focus'),
						...
						i.ui.onDialogShown(i.$dialog, function () {
							i.context.triggerEvent('dialog.shown'),
								...
								o
									...
									.val(''),
								z.isSupportTouch || o.trigger('focus'),
								i.bindEnterKey(o, n);
						}),
			...
			return (
				...
				(t.prototype.initialize = function () {
					...
					this.context.invoke('buttons.build', t, this.options.popover.table),
						z.isFF && document.execCommand('enableInlineTableEditing', !1, !1);
				}),
				(t.prototype.destroy = function () {
					this.$popover.remove();
				}),
				...
				(this.context = t),
					...
					(this.events = {
						...
						'summernote.focusout': function (t, e) {
							z.isFF ||
								(e.relatedTarget &&
									Nt.ancestor(e.relatedTarget, C.eq(o.$popover[0]))) ||
								o.hide();
						},
					});
			}
		...
		ce = (function () {
			...
			return (
				...
				(t.prototype.replace = function () {
					...
					if (t.length) {
						...
						this.lastWordRange.insertNode(e),
							Ft.createFromNode(e).collapse().select(),
							(this.lastWordRange = null),
							this.hide(),
							this.context.triggerEvent(
								'change',
				...
				(t.prototype.handleKeydown = function (t) {
					this.$popover.is(':visible') &&
						(t.keyCode === Lt.code.ENTER
							...
							: t.keyCode === Lt.code.UP
							? (t.preventDefault(), this.moveUp())
							: t.keyCode === Lt.code.DOWN &&
				...
				(t.prototype.handleKeyup = function (t) {
					var o = this;
					if (
						!N.contains([Lt.code.ENTER, Lt.code.UP, Lt.code.DOWN], t.keyCode)
					) {
						var e = this.context.invoke('editor.createRange').getWordRange(),
							n = e.toString();
		...
		de = (function () {
			...
			return (
				...
				(t.prototype.initializeModule = function (t) {
					...
					(e.shouldInitialize = e.shouldInitialize || C.ok),
						e.shouldInitialize() &&
							(e.initialize && e.initialize(),
							e.events && Nt.attachEvents(this.$note, e.events));
				}),
				...
				(t.prototype.removeModule = function (t) {
					var e = this.modules[t];
					e.shouldInitialize() &&
						(e.events && Nt.detachEvents(this.$note, e.events),
						e.destroy && e.destroy()),
	...
	k.fn.extend({
		summernote: function () {
			...
			(i.langInfo = k.extend(
				...
				(i.tooltip = 'auto' === i.tooltip ? !z.isSupportTouch : i.tooltip),
