...
!(function (t, e) {
	...
	var i = (function () {
				...
				(t.prototype.render = function (t) {
					...
					if (
						(this.options &&
							...
							o.html(this.options.contents),
						this.options &&
							this.options.className &&
							o.addClass(this.options.className),
						this.options &&
							this.options.data &&
							k.each(this.options.data, function (t, e) {
								o.attr('data-' + t, e);
							}),
						this.options &&
							this.options.click &&
							o.on('click', this.options.click),
						this.children)
					) {
			...
			function t(e, t) {
				if (
					...
					var o = this.show.bind(this),
						n = this.hide.bind(this),
						i = this.toggle.bind(this);
					this.options.trigger.split(' ').forEach(function (t) {
						'hover' === t
							? (e.off('mouseenter mouseleave'),
							  e.on('mouseenter', o).on('mouseleave', n))
							: 'click' === t
							? e.on('click', i)
							: 'focus' === t && e.on('focus', o).on('blur', n);
					});
				}
			}
			return (
				(t.prototype.show = function () {
					var t = this.$node,
						e = t.offset(),
						o = this.$tooltip,
						n = this.options.title || t.attr('title') || t.data('title'),
						i = this.options.placement || t.data('placement');
					o.addClass(i),
						o.addClass('in'),
						o.find('.note-tooltip-content').text(n),
					...
					var r = t.outerWidth(),
						...
						l = o.outerHeight();
					'bottom' === i
						? o.css({ top: e.top + s, left: e.left + (r / 2 - a / 2) })
						: 'top' === i
						? o.css({ top: e.top - l, left: e.left + (r / 2 - a / 2) })
						: 'left' === i
						? o.css({ top: e.top + (s / 2 - l / 2), left: e.left - a })
						: 'right' === i &&
						  o.css({ top: e.top + (s / 2 - l / 2), left: e.left + r });
				}),
				(t.prototype.hide = function () {
					this.$tooltip.removeClass('in'), this.$tooltip.remove();
				}),
		...
		o = (function () {
			function t(t, e) {
				(this.$button = t),
					(this.options = $.extend({}, { target: e.container }, e)),
					this.setEvent();
			}
			return (
				...
				(t.prototype.show = function () {
					...
					var t = this.$button.next(),
						...
						o = t.outerWidth(),
						n = $(window).width(),
						i = parseFloat($(this.options.target).css('margin-right'));
					e.left + o > n - i
	...
	$(document).on('click', function (t) {
		$(t.target).closest('.note-btn-group').length ||
			$('.note-btn-group.open').removeClass('open');
	}),
		$(document).on('click.note-dropdown-menu', function (t) {
			$(t.target).closest('.note-dropdown-menu').parent().removeClass('open');
		});
	var n = (function () {
			function t(t, e) {
				(this.options = $.extend({}, { target: e.container || 'body' }, e)),
					(this.$modal = t),
					(this.$backdrop = $('<div class="note-modal-backdrop" />'));
			}
			return (
				(t.prototype.show = function () {
					'body' === this.options.target
		...
		e = t('<div class="note-editor note-frame"/>'),
		r = t('<div class="note-toolbar" role="toolbar"/>'),
		s = t('<div class="note-editing-area"/>'),
		a = t(
		...
		f = t(
			...
			function (t, e) {
				e &&
					...
					t.data(
						'_lite_tooltip',
						new p(t, { title: e.tooltip, container: e.container })
					)),
					e.contents && t.html(e.contents),
					e &&
						e.data &&
						'dropdown' === e.data.toggle &&
						t.data('_lite_dropdown', new o(t, { container: e.container }));
			}
		),
		m = t('<div class="note-dropdown-menu" role="list">', function (t, i) {
			var e = $.isArray(i.items)
				? i.items.map(function (t) {
						...
						return n.html(o).data('item', t), n;
				  })
				: i.items;
			t.html(e).attr({ 'aria-label': i.title }),
				t.on('click', '> .note-dropdown-item', function (t) {
					var e = $(this),
						o = e.data('item'),
						n = e.data('value');
					o.click ? o.click(e) : i.itemClick && i.itemClick(t, o, n);
				});
		}),
		g = t(
			...
			function (t, i) {
				var e = $.isArray(i.items)
					? i.items.map(function (t) {
							...
							return n.html([w(i.checkClassName), ' ', o]).data('item', t), n;
					  })
					: i.items;
				t.html(e).attr({ 'aria-label': i.title }),
					t.on('click', '> .note-dropdown-item', function (t) {
		...
		v = t('<div class="note-color-palette"/>', function (t, e) {
			...
			t.html(o.join('')),
				t.find('.note-color-btn').each(function () {
					$(this).data(
						'_lite_tooltip',
						new p($(this), { container: e.container })
					);
				});
		}),
		b = t(
		...
		C = t('<div class="checkbox"></div>', function (t, e) {
			t.html(
				[
					'<label' + (e.id ? ' for="' + e.id + '"' : '') + '>',
		...
		x = {
			...
			dropdown: m,
			dropdownCheck: g,
			dropdownButton: function (t, e) {
				return h(
					[
						f({
							className: 'dropdown-toggle',
							contents: t.title + ' ' + w('note-icon-caret'),
							tooltip: t.tooltip,
			...
			dropdownCheckButton: function (t, e) {
				return h(
					[
						f({
							className: 'dropdown-toggle',
			...
			paragraphDropdownButton: function (t) {
				return h([
					f({
						className: 'dropdown-toggle',
						contents: t.title + ' ' + w('note-icon-caret'),
					...
					m([
						h({ className: 'note-align', children: t.items[0] }),
						h({ className: 'note-list', children: t.items[1] }),
					]),
				]).render();
			},
			tableDropdownButton: function (e) {
				return h(
					[
						f({
							className: 'dropdown-toggle',
							contents: e.title + ' ' + w('note-icon-caret'),
							tooltip: e.tooltip,
							data: { toggle: 'dropdown' },
						}),
						m({
								...
								.mousemove(function (t) {
									!(function (t, e, o) {
										var n,
											...
											r = i.next(),
											s = i.find('.note-dimension-picker-mousecatcher'),
											a = i.find('.note-dimension-picker-highlighted'),
											l = i.find('.note-dimension-picker-unhighlighted');
										if (void 0 === t.offsetX) {
											var c = $(t.target).offset();
											n = { x: t.pageX - c.left, y: t.pageY - c.top };
										} else n = { x: t.offsetX, y: t.offsetY };
										var d = Math.ceil(n.x / 18) || 1,
											u = Math.ceil(n.y / 18) || 1;
										a.css({ width: d + 'em', height: u + 'em' }),
											s.data('value', d + 'x' + u),
											3 < d && d < e && l.css({ width: d + 1 + 'em' }),
											3 < u && u < o && l.css({ height: u + 1 + 'em' }),
											r.html(d + ' x ' + u);
									})(t, e.col, e.row);
								});
						},
				...
				return h({
					...
					children: [
						f({
							...
							contents: c.title,
							tooltip: c.lang.color.recent,
							click: c.currentClick,
							callback: function (t) {
						...
						f({
							className: 'dropdown-toggle',
							contents: w('note-icon-caret'),
							tooltip: c.lang.color.more,
							data: { toggle: 'dropdown' },
						}),
						m({
							items: [
							...
							callback: function (t) {
								t.find('.note-holder').each(function () {
									var t = $(this);
									t.append(
										v({ colors: c.colors, eventName: t.data('event') }).render()
									);
								}),
									'fore' === d
										? (t.find('.btn-background-color').hide(),
										  t.css({ 'min-width': '210px' }))
										: 'back' === d &&
										  (t.find('.btn-foreground-color').hide(),
										  t.css({ 'min-width': '210px' }));
							},
							click: function (t) {
								var e = $(t.target),
									o = e.data('event'),
									n = e.data('value'),
									i = document.getElementById('html5fcp').value,
									r = document.getElementById('html5bcp').value;
								if (
									('cp' === n
										? t.stopPropagation()
										: 'cpbackColor' === n
									...
									var s = 'backColor' === o ? 'background-color' : 'color',
										a = e.closest('.note-color').find('.note-recent-color'),
										l = e
											.closest('.note-color')
									...
									a.css(s, n),
										l.attr('data-' + o, n),
										'fore' === d
											? c.itemClick('foreColor', n)
											: 'back' === d
											? c.itemClick('backColor', n)
											: c.itemClick(o, n);
								}
							},
						}),
			...
			videoDialog: function (t) {
				var e =
						'<div class="note-form-group"><label class="note-form-label">' +
						t.lang.video.url +
						' <small class="text-muted">' +
						t.lang.video.providers +
						'</small></label><input class="note-video-url note-input" type="text" /></div>',
					o = [
			...
			imageDialog: function (t) {
				var e =
						'<div class="note-form-group note-group-select-from-files"><label class="note-form-label">' +
						t.lang.image.selectFromFiles +
						'</label><input class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple" />' +
						t.imageLimitation +
						'</div><div class="note-form-group" style="overflow:auto;"><label class="note-form-label">' +
						t.lang.image.url +
						'</label><input class="note-image-url note-input" type="text" /></div>',
					o = [
			...
			linkDialog: function (t) {
				var e =
						...
						'</label><input class="note-link-text note-input" type="text" /></div><div class="note-form-group"><label class="note-form-label">' +
						t.lang.link.url +
						'</label><input class="note-link-url note-input" type="text" value="http://" /></div>' +
						(t.disableLinkTarget
							? ''
			...
			createLayout: function (t, e) {
				var o = (
					e.airMode
						? x.airEditor([x.editingArea([x.airEditable()])])
						: x.editor([
								x.toolbar(),
								x.editingArea([x.codable(), x.editable()]),
								x.statusbar(),
						  ])
				).render();
				return (
	...
	(k.summernote = k.summernote || { lang: {} }),
	...
	var S = 'function' == typeof define && define.amd;
	var T,
		I = navigator.userAgent,
		N = /MSIE|Trident/i.test(I);
	if (N) {
		var E = /MSIE (\d+[.]\d+)/.exec(I);
		E && (T = parseFloat(E[1])),
			(E = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(I)) &&
				(T = parseFloat(E[1]));
	}
	var A = /Edge\/\d+/.test(I),
		F = !!window.CodeMirror;
	if (!F && S)
		if ('function' == typeof __webpack_require__)
			try {
				require.resolve('codemirror'), (F = !0);
			} catch (t) {}
			...
			if (void 0 !== require.resolve)
				...
				void 0 !== require.specified && (F = require.specified('codemirror'));
	var R =
		...
		L = {
			...
			isMSIE: N,
			isEdge: A,
			isFF: !A && /firefox/i.test(I),
			isPhantom: /PhantomJS/i.test(I),
			isWebkit: !A && /webkit/i.test(I),
			isChrome: !A && /chrome/i.test(I),
			isSafari: !A && /safari/i.test(I),
			browserVersion: T,
	...
	var j = {
			...
			clusterBy: function (t, n) {
				return t.length
					? M(t).reduce(
							function (t, e) {
								var o = z(t);
								return n(z(o), e) ? (o[o.length] = e) : (t[t.length] = [e]), t;
							},
							[[B(t)]]
					  )
					: [];
		...
		K = {
			isEdit: function (t) {
				return j.contains([q.BACKSPACE, q.TAB, q.ENTER, q.SPACE, q.DELETE], t);
			},
			isMove: function (t) {
				return j.contains([q.LEFT, q.UP, q.RIGHT, q.DOWN], t);
			},
			nameFromCode: D.invertObject(q),
			code: q,
		},
	...
	function Z(t) {
		return !W(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase());
	}
	var Q = _('PRE'),
		X = _('LI');
	var J = _('TABLE'),
		tt = _('DATA');
	function et(t) {
		return !(st(t) || ot(t) || nt(t) || Z(t) || J(t) || rt(t) || tt(t));
	}
	function ot(t) {
	...
	var rt = _('BLOCKQUOTE');
	function st(t) {
		return it(t) || rt(t) || W(t);
	}
	var at = _('A');
	var lt = _('BODY');
	var ct = L.isMSIE && L.browserVersion < 11 ? '&nbsp;' : '<br>';
	function dt(t) {
		return G(t) ? t.nodeValue.length : t ? t.childNodes.length : 0;
	}
	function ut(t) {
		var e = dt(t);
		return (
			0 === e ||
			(!G(t) && 1 === e && t.innerHTML === ct) ||
			!(!j.all(t.childNodes, G) || '' !== t.innerHTML)
		);
	}
	function ht(t) {
		Y(t) || dt(t) || (t.innerHTML = ct);
	}
	function pt(t, e) {
		for (; t; ) {
			if (e(t)) return t;
	...
	function wt(t, e) {
		if (!e) return !1;
		for (; t && t !== e; ) {
			if (xt(t) !== dt(t.parentNode) - 1) return !1;
			t = t.parentNode;
		}
		return !0;
	}
	...
	function $t(t, e) {
		...
		if (0 === t.offset) {
			...
			(o = t.node.parentNode), (n = xt(t.node));
		} else n = St(t.node) ? dt((o = t.node.childNodes[t.offset - 1])) : ((o = t.node), e ? 0 : t.offset - 1);
		return { node: o, offset: n };
	}
	function Tt(t, e) {
		var o, n;
		if (dt(t.node) === t.offset) {
			if (W(t.node)) return null;
			(o = t.node.parentNode), (n = xt(t.node) + 1);
		} else n = St(t.node) ? ((o = t.node.childNodes[t.offset]), 0) : ((o = t.node), e ? dt(t.node) : t.offset + 1);
		return { node: o, offset: n };
	}
	function It(t, e) {
	...
	function Nt(t, e) {
		...
		if ((i && (o = !0), kt(t) && (G(t.node) || n))) {
			if (bt(t)) return t.node;
			if (yt(t)) return t.node.nextSibling;
		}
		if (G(t.node)) return t.node.splitText(t.offset);
		var r = t.node.childNodes[t.offset],
			s = gt(t.node.cloneNode(!1), t.node);
		return (
			vt(s, mt(r)),
			o || (ht(t.node), ht(s)),
			i && (ut(t.node) && Ft(t.node), ut(s)) ? (Ft(s), t.node.nextSibling) : s
		);
	}
	function Et(t, o, n) {
		var e = ft(o.node, D.eq(t));
		return e.length
			? 1 === e.length
				? Nt(o, n)
				: e.reduce(function (t, e) {
						return (
							t === o.node && (t = Nt(o, n)),
							Nt({ node: e, offset: t ? xt(t) : dt(e) }, n)
						);
				  })
			: null;
	}
	...
	var Lt = {
		...
		isLeftEdgePointOf: function (t, e) {
			return bt(t) && Ct(t.node, e);
		},
		isRightEdgePointOf: function (t, e) {
			return yt(t) && wt(t.node, e);
		},
		prevPoint: $t,
		nextPoint: Tt,
		isSamePoint: It,
		isVisiblePoint: function (t) {
			if (G(t.node) || !St(t.node) || ut(t.node)) return !0;
		...
		commonAncestor: function (t, e) {
			for (var o = ft(t), n = e; n; n = n.parentNode)
		...
		makeOffsetPath: function (t, e) {
			return ft(e, D.eq(t)).map(xt).reverse();
		},
		...
		splitPoint: function (t, e) {
			...
			var a =
				o && Et(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
			return (
				a || n !== t.node || (a = t.node.childNodes[t.offset]),
				{ rightNode: a, container: n }
			);
		},
		create: At,
		...
		isCustomStyleTag: function (t) {
			return t && !G(t) && j.contains(t.classList, 'note-styletag');
		},
	};
	function Ht(t, e) {
		var o,
			...
			s = j.from(i.childNodes);
		for (o = 0; o < s.length; o++)
			if (!Lt.isText(s[o])) {
				if (
					(r.moveToElementText(s[o]),
					0 <= r.compareEndPoints('StartToStart', t))
				)
					break;
				n = s[o];
			}
		if (0 !== o && Lt.isText(s[o - 1])) {
			var a = document.body.createTextRange(),
				l = null;
			a.moveToElementText(n || i),
				a.collapse(!n),
	...
	function Dt(t) {
		var s = function (t, e) {
				var o, n;
				if (Lt.isText(t)) {
					var i = Lt.listPrev(t, D.not(Lt.isText)),
						r = j.last(i).previousSibling;
					(o = r || t.parentNode),
						(e += j.sum(j.tail(i), Lt.nodeLength)),
						(n = !r);
				} else {
					if (((o = t.childNodes[e] || t), Lt.isText(o))) return s(o, 0);
					(e = 0), (n = !1);
				}
	...
	var Bt = (function () {
			function r(t, e, o, n) {
				(this.sc = t),
					...
					(this.ec = o),
					(this.eo = n),
					(this.isOnEditable = this.makeIsOn(Lt.isEditable)),
					(this.isOnList = this.makeIsOn(Lt.isList)),
					(this.isOnAnchor = this.makeIsOn(Lt.isAnchor)),
					(this.isOnCell = this.makeIsOn(Lt.isCell)),
					(this.isOnData = this.makeIsOn(Lt.isData));
			}
			return (
				(r.prototype.nativeRange = function () {
					...
					var e = Dt({ node: this.sc, offset: this.so });
					return (
						e.setEndPoint('EndToEnd', Dt({ node: this.ec, offset: this.eo })), e
					);
				}),
				...
				(r.prototype.normalize = function () {
					var t = function (t, e) {
							if (
								(Lt.isVisiblePoint(t) && !Lt.isEdgePoint(t)) ||
								(Lt.isVisiblePoint(t) && Lt.isRightEdgePoint(t) && !e) ||
								(Lt.isVisiblePoint(t) && Lt.isLeftEdgePoint(t) && e) ||
								(Lt.isVisiblePoint(t) &&
									Lt.isBlock(t.node) &&
									Lt.isEmpty(t.node))
							)
								return t;
							var o = Lt.ancestor(t.node, Lt.isBlock);
							if (
								((Lt.isLeftEdgePointOf(t, o) ||
									Lt.isVoid(Lt.prevPoint(t).node)) &&
									!e) ||
								((Lt.isRightEdgePointOf(t, o) ||
									Lt.isVoid(Lt.nextPoint(t).node)) &&
									e)
							) {
								if (Lt.isVisiblePoint(t)) return t;
								e = !e;
							}
							return (
								(e
									? Lt.nextPointUntil(Lt.nextPoint(t), Lt.isVisiblePoint)
									: Lt.prevPointUntil(Lt.prevPoint(t), Lt.isVisiblePoint)) || t
							);
						},
				...
				(r.prototype.nodes = function (o, t) {
					...
					return (
						Lt.walkPoint(
							...
							function (t) {
								var e;
								Lt.isEditable(t.node) ||
									(i
										? (Lt.isLeftEdgePoint(t) && a.push(t.node),
										  Lt.isRightEdgePoint(t) &&
												j.contains(a, t.node) &&
												(e = t.node))
										: (e = n ? Lt.ancestor(t.node, o) : t.node),
									e && o(e) && s.push(e));
							},
							!0
						),
				...
				(r.prototype.commonAncestor = function () {
					return Lt.commonAncestor(this.sc, this.ec);
				}),
				(r.prototype.expand = function (t) {
					var e = Lt.ancestor(this.sc, t),
						o = Lt.ancestor(this.ec, t);
					if (!e && !o) return new r(this.sc, this.so, this.ec, this.eo);
					var n = this.getPoints();
					return (
						e && ((n.sc = e), (n.so = 0)),
						o && ((n.ec = o), (n.eo = Lt.nodeLength(o))),
				...
				(r.prototype.splitText = function () {
					...
					return (
						Lt.isText(this.ec) &&
							!Lt.isEdgePoint(this.getEndPoint()) &&
							this.ec.splitText(this.eo),
						Lt.isText(this.sc) &&
							!Lt.isEdgePoint(this.getStartPoint()) &&
				...
				(r.prototype.deleteContents = function () {
					...
					var t = this.splitText(),
						...
						n = Lt.prevPointUntil(t.getStartPoint(), function (t) {
							return !j.contains(e, t.node);
						}),
						i = [];
					return (
						k.each(e, function (t, e) {
							var o = e.parentNode;
							n.node !== o && 1 === Lt.nodeLength(o) && i.push(o),
								Lt.remove(e, !1);
						}),
				...
				(r.prototype.makeIsOn = function (e) {
					return function () {
						var t = Lt.ancestor(this.sc, e);
						return !!t && t === Lt.ancestor(this.ec, e);
					};
				}),
				(r.prototype.isLeftEdgeOf = function (t) {
					if (!Lt.isLeftEdgePoint(this.getStartPoint())) return !1;
					var e = Lt.ancestor(this.sc, t);
					return e && Lt.isLeftEdgeOf(this.sc, e);
				}),
				(r.prototype.isCollapsed = function () {
					return this.sc === this.ec && this.so === this.eo;
				}),
				(r.prototype.wrapBodyInlineWithPara = function () {
					if (Lt.isBodyContainer(this.sc) && Lt.isEmpty(this.sc))
						return (
							(this.sc.innerHTML = Lt.emptyPara),
							new r(this.sc.firstChild, 0, this.sc.firstChild, 0)
						);
					var t,
						e = this.normalize();
					if (Lt.isParaInline(this.sc) || Lt.isPara(this.sc)) return e;
					if (Lt.isInline(e.sc)) {
						var o = Lt.listAncestor(e.sc, D.not(Lt.isInline));
						(t = j.last(o)),
							Lt.isInline(t) || (t = o[o.length - 2] || e.sc.childNodes[e.so]);
					} else t = e.sc.childNodes[0 < e.so ? e.so - 1 : 0];
					var n = Lt.listPrev(t, Lt.isParaInline).reverse();
					if (
						(n = n.concat(Lt.listNext(t.nextSibling, Lt.isParaInline))).length
					) {
						var i = Lt.wrap(j.head(n), 'p');
						Lt.appendChildNodes(i, j.tail(n));
					}
					return this.normalize();
				}),
				(r.prototype.insertNode = function (t) {
					var e = this.wrapBodyInlineWithPara().deleteContents(),
						o = Lt.splitPoint(e.getStartPoint(), Lt.isInline(t));
					return (
						o.rightNode
							? o.rightNode.parentNode.insertBefore(t, o.rightNode)
				...
				(r.prototype.toString = function () {
					var t = this.nativeRange();
					return L.isW3CRangeSupport ? t.toString() : t.text;
				}),
				(r.prototype.getWordRange = function (t) {
					var e = this.getEndPoint();
					if (!Lt.isCharPoint(e)) return this;
					var o = Lt.prevPointUntil(e, function (t) {
						return !Lt.isCharPoint(t);
					});
					return (
						t &&
							(e = Lt.nextPointUntil(e, function (t) {
								return !Lt.isCharPoint(t);
							})),
				...
				(r.prototype.bookmark = function (t) {
					return {
						s: { path: Lt.makeOffsetPath(t, this.sc), offset: this.so },
						e: { path: Lt.makeOffsetPath(t, this.ec), offset: this.eo },
					};
				}),
				(r.prototype.paraBookmark = function (t) {
					return {
						s: {
							path: j.tail(Lt.makeOffsetPath(j.head(t), this.sc)),
							offset: this.so,
						},
						e: {
							path: j.tail(Lt.makeOffsetPath(j.last(t), this.ec)),
							offset: this.eo,
						},
					};
				}),
		...
		zt = {
			create: function (t, e, o, n) {
				...
				if (2 === arguments.length) return new Bt((o = t), (n = e), o, n);
				var i = this.createFromSelection();
				return i || 1 !== arguments.length
					? i
					: (i = this.createFromNode(t)).collapse(Lt.emptyPara === t.innerHTML);
			},
			createFromSelection: function () {
				...
				if (L.isW3CRangeSupport) {
					...
					if (Lt.isBody(i.anchorNode)) return null;
					...
					var c = Ht(l, !0),
						d = Ht(a, !1);
					Lt.isText(c.node) &&
						Lt.isLeftEdgePoint(c) &&
						Lt.isTextNode(d.node) &&
						Lt.isRightEdgePoint(d) &&
			...
			createFromNode: function (t) {
				var e = t,
					...
					i = Lt.nodeLength(n);
				return (
					Lt.isVoid(e) && ((o = Lt.listPrev(e).length - 1), (e = e.parentNode)),
					Lt.isBR(n)
						? ((i = Lt.listPrev(n).length - 1), (n = n.parentNode))
						: Lt.isVoid(n) && ((i = Lt.listPrev(n).length), (n = n.parentNode)),
					this.create(e, o, n, i)
				);
			},
			...
			createFromBookmark: function (t, e) {
				var o = Lt.fromOffsetPath(t, e.s.path),
					n = e.s.offset,
					i = Lt.fromOffsetPath(t, e.e.path),
					r = e.e.offset;
			...
			createFromParaBookmark: function (t, e) {
				var o = t.s.offset,
					n = t.e.offset,
					i = Lt.fromOffsetPath(j.head(e), t.s.path),
					r = Lt.fromOffsetPath(j.last(e), t.e.path);
	...
	var Mt = (function () {
			...
			return (
				...
				(t.prototype.applySnapshot = function (t) {
					null !== t.contents && this.$editable.html(t.contents),
						null !== t.bookmark &&
							zt.createFromBookmark(this.editable, t.bookmark).select();
				}),
				(t.prototype.rewind = function () {
					this.$editable.html() !== this.stack[this.stackOffset].contents &&
						this.recordUndo(),
						(this.stackOffset = 0),
		...
		Ot = (function () {
			...
			return (
				...
				(t.prototype.stylePara = function (t, o) {
					k.each(t.nodes(Lt.isPara, { includeAncestor: !0 }), function (t, e) {
						k(e).css(o);
					});
				}),
				(t.prototype.styleNodes = function (t, e) {
					...
					if (t.isCollapsed()) return [t.insertNode(Lt.create(o))];
					var r = Lt.makePredByNodeName(o),
						s = t.nodes(Lt.isText, { fullyContains: !0 }).map(function (t) {
							return Lt.singleChildAncestor(t, r) || Lt.wrap(t, o);
						});
					if (n) {
						if (i) {
							var a = t.nodes();
							r = D.and(r, function (t) {
								return j.contains(a, t);
							});
						}
						return s.map(function (t) {
							var e = Lt.withClosestSiblings(t, r),
								o = j.head(e),
								n = j.tail(e);
							return (
								k.each(n, function (t, e) {
									Lt.appendChildNodes(o, e.childNodes), Lt.remove(e);
								}),
								j.head(e)
							);
						});
				...
				(t.prototype.current = function (t) {
					var e = k(Lt.isElement(t.sc) ? t.sc : t.sc.parentNode),
						o = this.fromNode(e);
					try {
						o = k.extend(o, {
							...
							'font-strikethrough': document.queryCommandState('strikethrough')
								...
								: 'normal',
							'font-family':
								document.queryCommandValue('fontname') || o['font-family'],
						});
					} catch (t) {}
					if (t.isOnList()) {
						var n =
							-1 <
							k.inArray(o['list-style-type'], [
								'circle',
								'disc',
								'disc-leading-zero',
								'square',
					...
					var i = Lt.ancestor(t.sc, Lt.isPara);
					if (i && i.style['line-height'])
						o['line-height'] = i.style.lineHeight;
					else {
						var r =
							parseInt(o['line-height'], 10) / parseInt(o['font-size'], 10);
						o['line-height'] = r.toFixed(1);
					}
					return (
						(o.anchor = t.isOnAnchor() && Lt.ancestor(t.sc, Lt.isAnchor)),
						(o.ancestors = Lt.listAncestor(t.sc, Lt.isEditable)),
						(o.range = t),
						o
					);
				}),
		...
		Ut = (function () {
			...
			return (
				...
				(t.prototype.indent = function (t) {
					var i = this,
						e = zt.create(t).wrapBodyInlineWithPara(),
						o = e.nodes(Lt.isPara, { includeAncestor: !0 }),
						n = j.clusterBy(o, D.peq2('parentNode'));
					k.each(n, function (t, e) {
						var o = j.head(e);
						if (Lt.isLi(o)) {
				...
				(t.prototype.outdent = function (t) {
					var n = this,
						e = zt.create(t).wrapBodyInlineWithPara(),
						o = e.nodes(Lt.isPara, { includeAncestor: !0 }),
						i = j.clusterBy(o, D.peq2('parentNode'));
					k.each(i, function (t, e) {
						var o = j.head(e);
						Lt.isLi(o)
							? n.releaseList([e])
				...
				(t.prototype.toggleList = function (o, t) {
					var n = this,
						e = zt.create(t).wrapBodyInlineWithPara(),
						i = e.nodes(Lt.isPara, { includeAncestor: !0 }),
						r = e.paraBookmark(i),
						s = j.clusterBy(i, D.peq2('parentNode'));
					if (j.find(i, Lt.isPurePara)) {
						var a = [];
						...
						var l = e
							.nodes(Lt.isList, { includeAncestor: !0 })
							.filter(function (t) {
					...
					zt.createFromParaBookmark(r, i).select();
				}),
				(t.prototype.wrapList = function (t, e) {
					var o = j.head(t),
						n = j.last(t),
						i = Lt.isList(o.previousSibling) && o.previousSibling,
						r = Lt.isList(n.nextSibling) && n.nextSibling,
						s = i || Lt.insertAfter(Lt.create(e || 'UL'), n);
					return (
						(t = t.map(function (t) {
							return Lt.isPurePara(t) ? Lt.replace(t, 'LI') : t;
						})),
						Lt.appendChildNodes(s, t),
						r && (Lt.appendChildNodes(s, j.from(r.childNodes)), Lt.remove(r)),
						t
					);
				}),
				(t.prototype.releaseList = function (t, c) {
					...
					return (
						k.each(t, function (t, e) {
							var o = j.head(e),
								n = j.last(e),
								i = c ? Lt.lastAncestor(o, Lt.isList) : o.parentNode,
								r = i.parentNode;
							if ('LI' === i.parentNode.nodeName)
								...
								var s =
										1 < i.childNodes.length
											? Lt.splitTree(
													i,
													{ node: n.parentNode, offset: Lt.position(n) + 1 },
													{ isSkipPaddingBlankHTML: !0 }
											  )
											: null,
									a = Lt.splitTree(
										i,
										{ node: o.parentNode, offset: Lt.position(o) },
										{ isSkipPaddingBlankHTML: !0 }
									);
								(e = c
									? Lt.listDescendant(a, Lt.isLi)
									: j.from(a.childNodes).filter(Lt.isLi)),
									(!c && Lt.isList(i.parentNode)) ||
										(e = e.map(function (t) {
											return Lt.replace(t, 'P');
										})),
									k.each(j.from(e).reverse(), function (t, e) {
										Lt.insertAfter(e, i);
									});
								var l = j.compact([i, a, s]);
								k.each(l, function (t, e) {
									var o = [e].concat(Lt.listDescendant(e, Lt.isList));
									k.each(o.reverse(), function (t, e) {
										Lt.nodeLength(e) || Lt.remove(e, !0);
									});
								});
							}
							u = u.concat(e);
				...
				(t.prototype.appendToPrevious = function (t) {
					return t.previousSibling
						? Lt.appendChildNodes(t.previousSibling, [t])
						: this.wrapList([t], 'LI');
				}),
				(t.prototype.findList = function (t) {
					return t
						? j.find(t.children, function (t) {
		...
		jt = (function () {
			function t(t) {
				(this.bullet = new Ut()), (this.options = t.options);
			}
			return (
				(t.prototype.insertTab = function (t, e) {
					var o = Lt.createText(new Array(e + 1).join(Lt.NBSP_CHAR));
					(t = t.deleteContents()).insertNode(o, !0),
						(t = zt.create(o, e)).select();
				}),
				(t.prototype.insertParagraph = function (t, e) {
					e = (e = (e =
						e || zt.create(t)).deleteContents()).wrapBodyInlineWithPara();
					var o,
						n = Lt.ancestor(e.sc, Lt.isPara);
					if (n) {
						if (Lt.isEmpty(n) && Lt.isLi(n))
							return void this.bullet.toggleList(n.parentNode.nodeName);
						var i = null;
						if (
							(1 === this.options.blockquoteBreakingLevel
								? (i = Lt.ancestor(n, Lt.isBlockquote))
								: 2 === this.options.blockquoteBreakingLevel &&
								  (i = Lt.lastAncestor(n, Lt.isBlockquote)),
							i)
						) {
							(o = k(Lt.emptyPara)[0]),
								Lt.isRightEdgePoint(e.getStartPoint()) &&
									Lt.isBR(e.sc.nextSibling) &&
									k(e.sc.nextSibling).remove();
							var r = Lt.splitTree(i, e.getStartPoint(), {
								isDiscardEmptySplits: !0,
							});
							r ? r.parentNode.insertBefore(o, r) : Lt.insertAfter(o, i);
						} else {
							o = Lt.splitTree(n, e.getStartPoint());
							var s = Lt.listDescendant(n, Lt.isEmptyAnchor);
							(s = s.concat(Lt.listDescendant(o, Lt.isEmptyAnchor))),
								k.each(s, function (t, e) {
									Lt.remove(e);
								}),
								(Lt.isHeading(o) || Lt.isPre(o) || Lt.isCustomStyleTag(o)) &&
									Lt.isEmpty(o) &&
									(o = Lt.replace(o, 'p'));
						}
					} else {
						...
						(o = k(Lt.emptyPara)[0]),
							a ? e.sc.insertBefore(o, a) : e.sc.appendChild(o);
					}
					zt.create(o, 0).normalize().select().scrollIntoView(t);
				}),
				t
			);
		})(),
		qt = function (t, h, p, i) {
			...
			function b(t, e) {
				if (!m[t]) return e;
				if (!m[t][e]) return e;
				for (var o = e; m[t][o]; ) if ((o++, !m[t][o])) return o;
			}
			function r(t, e) {
			...
			function k(t) {
				switch (h) {
					case qt.where.Column:
						if (t.isColSpan) return qt.resultAction.SubtractSpanCount;
						break;
					case qt.where.Row:
						if (!t.isVirtual && t.isRowSpan) return qt.resultAction.AddCell;
						if (t.isRowSpan) return qt.resultAction.SubtractSpanCount;
				}
				return qt.resultAction.RemoveCell;
			}
			function C(t) {
				switch (h) {
					case qt.where.Column:
						if (t.isColSpan) return qt.resultAction.SumSpanCount;
						if (t.isRowSpan && t.isVirtual) return qt.resultAction.Ignore;
						break;
					case qt.where.Row:
						if (t.isRowSpan) return qt.resultAction.SumSpanCount;
						if (t.isColSpan && t.isVirtual) return qt.resultAction.Ignore;
				}
				return qt.resultAction.AddCell;
			}
			(this.getActionList = function () {
				for (
					var t,
						e,
						o,
						n = h === qt.where.Row ? f.rowPos : -1,
						i = h === qt.where.Column ? f.colPos : -1,
						r = 0,
						s = !0;
					s;
					...
					var d = c[l];
					if (!d) return (s = !1), g;
					var u = qt.resultAction.Ignore;
					switch (p) {
						case qt.requestAction.Add:
							u = C(d);
							break;
						case qt.requestAction.Delete:
							u = k(d);
					}
					g.push(
						((t = u),
				...
				('td' === t.tagName.toLowerCase() || 'th' === t.tagName.toLowerCase())
					? ((f.colPos = t.cellIndex),
					  t.parentElement &&
					  t.parentElement.tagName &&
					  'tr' === t.parentElement.tagName.toLowerCase()
							? (f.rowPos = t.parentElement.rowIndex)
							: console.error('Impossible to identify start Row point.', t))
	...
	(qt.where = { Row: 0, Column: 1 }),
		(qt.requestAction = { Add: 0, Delete: 1 }),
		(qt.resultAction = {
			Ignore: 0,
			SubtractSpanCount: 1,
			RemoveCell: 2,
		...
		Vt = (function () {
			...
			return (
				(t.prototype.tab = function (t, e) {
					var o = Lt.ancestor(t.commonAncestor(), Lt.isCell),
						n = Lt.ancestor(o, Lt.isTable),
						i = Lt.listDescendant(n, Lt.isCell),
						r = j[e ? 'prev' : 'next'](i, o);
					r && zt.create(r, 0).select();
				}),
				(t.prototype.addRow = function (t, e) {
					for (
						...
						switch (l.action) {
							case qt.resultAction.AddCell:
								r.append('<td' + c + '>' + Lt.blank + '</td>');
								break;
							case qt.resultAction.SumSpanCount:
								if ('top' === e)
									if (
										(l.baseCell.parent
				...
				(t.prototype.addCol = function (t, e) {
					...
					for (
						...
						switch (s.action) {
							case qt.resultAction.AddCell:
								'right' === e
									? k(s.baseCell).after('<td' + a + '>' + Lt.blank + '</td>')
									: k(s.baseCell).before('<td' + a + '>' + Lt.blank + '</td>');
								break;
							case qt.resultAction.SumSpanCount:
								if ('right' === e) {
				...
				(t.prototype.deleteRow = function (t) {
					for (
						var e = Lt.ancestor(t.commonAncestor(), Lt.isCell),
							o = k(e).closest('tr'),
							n = o.children('td, th').index(k(e)),
							i = o[0].rowIndex,
							r = new qt(
								e,
								qt.where.Row,
								qt.requestAction.Delete,
								k(o).closest('table')[0]
							).getActionList(),
							s = 0;
						s < r.length;
									...
									c &&
										(2 < d
											? (d--,
											  ...
											  u.cells[n].setAttribute('rowSpan', d),
											  (u.cells[n].innerHTML = ''))
											: 2 === d &&
											  (u.insertBefore(h, u.cells[n]),
											  ...
											  (u.cells[n].innerHTML = '')));
									continue;
								case qt.resultAction.SubtractSpanCount:
									c &&
										(2 < d
											? (d--,
											  a.setAttribute('rowSpan', d),
											  l.rowIndex !== i &&
													a.cellIndex === n &&
													(a.innerHTML = ''))
											: 2 === d &&
											  ...
											  l.rowIndex !== i &&
													...
													(a.innerHTML = '')));
									continue;
								case qt.resultAction.RemoveCell:
									continue;
							}
						}
					o.remove();
		...
		Wt = (function () {
			function t(t) {
				...
				(this.context = t),
					...
					(this.style = new Ot()),
					(this.table = new Vt()),
					(this.typing = new jt(t)),
					(this.bullet = new Ut()),
					(this.history = new Mt(this.$editable)),
				...
				(this.insertParagraph = this.wrapCommand(function () {
					...
					(this.insertNode = this.wrapCommand(function (t) {
						u.isLimited(k(t).text().length) ||
							(u.createRange().insertNode(t),
							zt.createFromNodeAfter(t).select());
					})),
					(this.insertText = this.wrapCommand(function (t) {
						if (!u.isLimited(t.length)) {
							var e = u.createRange().insertNode(Lt.createText(t));
							zt.create(e, Lt.nodeLength(e)).select();
						}
					})),
					(this.pasteHTML = this.wrapCommand(function (t) {
						if (!u.isLimited(t.length)) {
							var e = u.createRange().pasteHTML(t);
							zt.createFromNodeAfter(j.last(e)).select();
						}
					})),
					(this.formatBlock = this.wrapCommand(function (t, e) {
						var o = u.options.callbacks.onApplyCustomStyle;
						o
							? o.call(u, e, u.context, u.onFormatBlock)
							: u.onFormatBlock(t, e);
					})),
					(this.insertHorizontalRule = this.wrapCommand(function () {
						var t = u.createRange().insertNode(Lt.create('HR'));
						t.nextSibling && zt.create(t.nextSibling, 0).normalize().select();
					})),
					(this.lineHeight = this.wrapCommand(function (t) {
						u.style.stylePara(u.createRange(), { lineHeight: t });
					})),
					(this.createLink = this.wrapCommand(function (t) {
						...
						if (!(0 < r && u.isLimited(r))) {
							...
							'string' == typeof o && (o = o.trim()),
								u.options.onCreateLink
									? (o = u.options.onCreateLink(o))
									: /^\.?\/(.*)/.test(o) ||
							...
							var a = [];
							if (s) {
								var l = (i = i.deleteContents()).insertNode(
									k('<A>' + e + '</A>')[0]
								);
								a.push(l);
							} else
								a = u.style.styleNodes(i, {
									nodeName: 'A',
							...
							k.each(a, function (t, e) {
								k(e).attr('href', o),
									n ? k(e).attr('target', '_blank') : k(e).removeAttr('target');
							});
							var c = zt.createFromNodeBefore(j.head(a)).getStartPoint(),
								d = zt.createFromNodeAfter(j.last(a)).getEndPoint();
							zt.create(c.node, c.offset, d.node, d.offset).select();
						}
					})),
					...
					(this.insertTable = this.wrapCommand(function (t) {
						...
						u.createRange()
							.deleteContents()
							.insertNode(u.table.createTable(e[0], e[1], u.options));
					})),
					(this.removeMedia = this.wrapCommand(function () {
						var t = k(u.restoreTarget()).parent();
						t.parent('figure').length
							? t.parent('figure').remove()
							: (t = k(u.restoreTarget()).detach()),
							u.context.triggerEvent('media.delete', t, u.$editable);
					})),
					...
					(this.resize = this.wrapCommand(function (t) {
						k(u.restoreTarget()).css({ width: 100 * t + '%', height: '' });
					}));
			}
			return (
				(t.prototype.initialize = function () {
					...
					this.$editable
						...
						this.$editable.html(Lt.html(this.$note) || Lt.emptyPara),
						this.$editable.on(
							L.inputEventName,
							D.debounce(function () {
				...
				(t.prototype.handleKeyMap = function (t) {
					var e = this.options.keyMap[L.isMac ? 'mac' : 'pc'],
						o = [];
					t.metaKey && o.push('CMD'),
						t.ctrlKey && !t.altKey && o.push('CTRL'),
						t.shiftKey && o.push('SHIFT');
					var n = K.nameFromCode[t.keyCode];
					n && o.push(n);
					var i = e[o.join('+')];
					i
						? !1 !== this.context.invoke(i) && t.preventDefault()
						: K.isEdit(t.keyCode) && this.afterCommand();
				}),
				(t.prototype.preventDefaultEditableShortCuts = function (t) {
					(t.ctrlKey || t.metaKey) &&
						j.contains([66, 73, 85], t.keyCode) &&
						t.preventDefault();
				}),
					...
					return (
						...
						(void 0 === e ||
							!(
								...
								e.ctrlKey ||
								e.metaKey ||
								j.contains([K.code.BACKSPACE, K.code.DELETE], e.keyCode)
							)) &&
				...
				(t.prototype.createRange = function () {
					return this.focus(), zt.create(this.editable);
				}),
				...
				(t.prototype.afterCommand = function (t) {
					this.normalizeContent(),
						this.history.recordUndo(),
						t || this.context.triggerEvent('change', this.$editable.html());
				}),
							...
							n.beforeCommand(),
								'function' == typeof e
									...
									: ('string' == typeof e && t.attr('data-filename', e),
									  t.css('width', Math.min(n.$editable.width(), t.width()))),
								t.show(),
								zt.create(n.editable).insertNode(t[0]),
								zt.createFromNodeAfter(t[0]).select(),
								n.afterCommand();
						})
						.fail(function (t) {
				...
				(t.prototype.getSelectedText = function () {
					...
					return (
						t.isOnAnchor() &&
							(t = zt.createFromNode(Lt.ancestor(t.sc, Lt.isAnchor))),
						t.toString()
					);
				}),
				...
				(t.prototype.fontStyling = function (t, e) {
					...
					if (o) {
						...
						if ((k(n).css(t, e), o.isCollapsed())) {
							...
							i &&
								!Lt.nodeLength(i) &&
								((i.innerHTML = Lt.ZERO_WIDTH_NBSP_CHAR),
								zt.createFromNodeAfter(i.firstChild).select(),
				...
				(t.prototype.unlink = function () {
					var t = this.createRange();
					if (t.isOnAnchor()) {
						var e = Lt.ancestor(t.sc, Lt.isAnchor);
						(t = zt.createFromNode(e)).select(),
							this.beforeCommand(),
				...
				(t.prototype.getLinkInfo = function () {
					var t = this.createRange().expand(Lt.isAnchor),
						e = k(j.head(t.nodes(Lt.isAnchor))),
						o = {
							range: t,
							text: t.toString(),
				...
				(t.prototype.resizeTo = function (t, e, o) {
					...
					if (o) {
						var i = t.y / t.x,
							r = e.data('ratio');
						n = { width: i < r ? t.x : t.y / r, height: i < r ? t.x * r : t.y };
				...
				(t.prototype.isEmpty = function () {
					return (
						Lt.isEmpty(this.$editable[0]) ||
						Lt.emptyPara === this.$editable.html()
					);
				}),
				(t.prototype.empty = function () {
					this.context.invoke('code', Lt.emptyPara);
				}),
			...
			return (
				...
				(t.prototype.pasteByEvent = function (t) {
					...
					if (e && e.items && e.items.length) {
						var o = 1 < e.items.length ? e.items[1] : j.head(e.items);
						'file' === o.kind &&
	...
	L.hasCodeMirror &&
		(L.isSupportAmd
			? require(['codemirror'], function (t) {
					Kt = t;
			  })
			: (Kt = window.CodeMirror));
	var Yt = (function () {
			function t(t) {
				(this.context = t),
					(this.$editor = t.layoutInfo.editor),
			...
			return (
				...
				(t.prototype.activate = function () {
					...
					if (
						(this.$codable.val(
							Lt.html(this.$editable, this.options.prettifyHtml)
						),
						...
						var o = Kt.fromTextArea(this.$codable[0], this.options.codemirror);
						if (this.options.codemirror.tern) {
							var n = new Kt.TernServer(this.options.codemirror.tern);
							(o.ternServer = n),
				...
				(t.prototype.deactivate = function () {
					...
					var e =
							Lt.value(this.$codable, this.options.prettifyHtml) ||
							Lt.emptyPara,
		...
		Qt = (function () {
			function t(t) {
				...
				(this.context = t),
					...
					(this.$editable = t.layoutInfo.editable),
					(this.$codable = t.layoutInfo.codable),
					(this.$window = k(window)),
					(this.$scrollbar = k('html, body')),
				...
				(t.prototype.initialize = function () {
					...
					(this.$handle = k(
						...
						this.$handle.on('mousedown', function (t) {
							if (Lt.isControlSizing(t.target)) {
								t.preventDefault(), t.stopPropagation();
								var e = r.$handle
				...
				(t.prototype.update = function (t) {
					...
					if ((this.context.invoke('imagePopover.update', t), e)) {
						var n = k(t),
							...
							s = { w: n.outerWidth(!1), h: n.outerHeight(!1) };
						o.css({
							display: 'block',
							left: r.left,
							top: r.top,
						...
						var l =
							...
							a.height +
							')';
						o.find('.note-control-selection-info').text(l),
		...
		ee = (function () {
			...
			return (
				(t.prototype.shouldInitialize = function () {
					return Lt.isTextarea(this.$note[0]);
				}),
				t
			);
		})(),
		oe = (function () {
			...
			return (
				...
				(t.prototype.initialize = function () {
					var t = this;
					(this.$placeholder = k('<div class="note-placeholder">')),
						this.$placeholder
							.on('click', function () {
		...
		ne = (function () {
			function t(t) {
				(this.ui = k.summernote.ui),
					(this.context = t),
					(this.$toolbar = t.layoutInfo.toolbar),
					(this.options = t.options),
					(this.lang = this.options.langInfo),
					(this.invertedKeyMap = D.invertObject(
						this.options.keyMap[L.isMac ? 'mac' : 'pc']
					));
			}
			return (
				(t.prototype.representShortcut = function (t) {
					...
					return this.options.shortcuts && e
						? (L.isMac && (e = e.replace('CMD', '⌘').replace('SHIFT', '⇧')),
						  ' (' +
								(e = e
									.replace('BACKSLASH', '\\')
									.replace('SLASH', '/')
					...
					return (
						this.fontInstalledMap.hasOwnProperty(t) ||
							(this.fontInstalledMap[t] =
								L.isFontInstalled(t) ||
								j.contains(this.options.fontNamesIgnoreCheck, t)),
						this.fontInstalledMap[t]
					);
				}),
									...
									click: function (t) {
										...
										if ('openPalette' === n) {
											...
											a
												...
												s.prepend(a),
												r.click();
										} else if (j.contains(['backColor', 'foreColor'], n)) {
				...
				(t.prototype.addToolbarButtons = function () {
								...
								n.ui.dropdown({
									...
									template: function (t) {
										'string' == typeof t &&
											(t = {
												tag: t,
												title: n.lang.style.hasOwnProperty(t)
													? n.lang.style[t]
													: t,
											});
										var e = t.tag,
								...
								i.context.memo('button.style.' + o, function () {
									return n
										.button({
											...
											click:
												n.context.createInvokeHandler('editor.formatBlock'),
										})
										.render();
								});
							},
					...
					this.context.memo('button.bold', function () {
						return n
							.button({
								...
								click:
									n.context.createInvokeHandlerAndUpdateState('editor.bold'),
							})
							.render();
					}),
						this.context.memo('button.italic', function () {
							return n
								.button({
									...
									click:
										n.context.createInvokeHandlerAndUpdateState(
											'editor.italic'
										),
								})
								.render();
						...
						this.context.memo('button.underline', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.font.underline + n.representShortcut('underline'),
									click:
										n.context.createInvokeHandlerAndUpdateState(
											'editor.underline'
										),
						...
						this.context.memo('button.clear', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.font.clear + n.representShortcut('removeFormat'),
						...
						this.context.memo('button.strikethrough', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.font.strikethrough +
										n.representShortcut('strikethrough'),
									click: n.context.createInvokeHandlerAndUpdateState(
						...
						this.context.memo('button.fontname', function () {
							...
							return (
								k.each(t['font-family'].split(','), function (t, e) {
									(e = e.trim().replace(/['"]+/g, '')),
										n.isFontDeservedToAdd(e) &&
											-1 === k.inArray(e, n.options.fontNames) &&
								...
								n.ui
									.buttonGroup([
										...
										n.ui.dropdownCheck({
											...
											items: n.options.fontNames.filter(
												n.isFontInstalled.bind(n)
											),
						...
						this.context.memo('button.ul', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.lists.unordered +
										n.representShortcut('insertUnorderedList'),
									click: n.context.createInvokeHandler(
						...
						this.context.memo('button.ol', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.lists.ordered +
										n.representShortcut('insertOrderedList'),
									click: n.context.createInvokeHandler(
					...
					this.context.memo('button.justifyLeft', D.invoke(r, 'render')),
						this.context.memo('button.justifyCenter', D.invoke(s, 'render')),
						this.context.memo('button.justifyRight', D.invoke(a, 'render')),
						this.context.memo('button.justifyFull', D.invoke(l, 'render')),
						this.context.memo('button.outdent', D.invoke(c, 'render')),
						this.context.memo('button.indent', D.invoke(d, 'render')),
									...
									],
									{
										callback: function (t) {
											t.find('.note-dimension-picker-mousecatcher')
												...
												.mousedown(
													n.context.createInvokeHandler('editor.insertTable')
												)
						...
						this.context.memo('button.link', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.link.link + n.representShortcut('linkDialog.show'),
						...
						this.context.memo('button.hr', function () {
							return n
								.button({
									...
									tooltip:
										n.lang.hr.insert +
										n.representShortcut('insertHorizontalRule'),
									click: n.context.createInvokeHandler(
				...
				(t.prototype.build = function (t, e) {
					for (var o = 0, n = e.length; o < n; o++) {
						for (
							var i = e[o],
								r = k.isArray(i) ? i[0] : i,
								s = k.isArray(i) ? (1 === i.length ? [i[0]] : i[1]) : [i],
								a = this.ui.buttonGroup({ className: 'note-' + r }).render(),
								l = 0,
								c = s.length;
							l < c;
							l++
				...
				(t.prototype.updateCurrentStyle = function (t) {
					...
					if (
						...
						var i = o['font-family'].split(',').map(function (t) {
							...
							r = j.find(i, this.isFontInstalled.bind(this));
			...
			return (
				...
				(t.prototype.followScroll = function () {
					...
					this.options.otherStaticBar &&
						(i = k(this.options.otherStaticBar).outerHeight());
					var r = this.$document.scrollTop(),
						s = this.$editor.offset().top;
					s - i < r && r < s + e - i - n
						? this.$toolbar.css({ position: 'fixed', top: i, width: o })
						: this.$toolbar.css({
								position: 'relative',
								top: 0,
								width: '100%',
						...
						.Deferred(function (n) {
							...
							c.ui.onDialogShown(c.$dialog, function () {
								...
								r
									...
									.val(l.url),
									L.isSupportTouch || r.trigger('focus'),
									c.toggleLinkBtn(s, i, r),
									c.bindEnterKey(r, s),
									c.bindEnterKey(i, s);
								var o =
									void 0 !== l.isNewWindow
										? l.isNewWindow
										: c.context.options.linkTargetBlank;
								a.prop('checked', o),
								...
								c.ui.onDialogHidden(c.$dialog, function () {
									i.off('input paste keypress'),
										r.off('input paste keypress'),
										s.off('click'),
		...
		se = (function () {
			...
			return (
				(t.prototype.shouldInitialize = function () {
					return !j.isEmpty(this.options.popover.link);
				}),
				(t.prototype.initialize = function () {
							...
							.then(function (t) {
								e.ui.hideDialog(e.$dialog),
									...
									'string' == typeof t
										...
										: e.context.invoke('editor.insertImagesAsDataURL', t);
							})
							.fail(function () {
								e.context.invoke('editor.restoreRange');
							});
						...
						i.ui.onDialogShown(i.$dialog, function () {
							i.context.triggerEvent('dialog.shown'),
								...
								o
									...
									.val(''),
								L.isSupportTouch || o.trigger('focus'),
								i.bindEnterKey(o, n);
						}),
		...
		le = (function () {
			...
			return (
				(t.prototype.shouldInitialize = function () {
					return !j.isEmpty(this.options.popover.image);
				}),
				(t.prototype.initialize = function () {
					this.$popover = this.ui
				...
				(t.prototype.update = function (t) {
					if (Lt.isImg(t)) {
						var e = Lt.posFromPlaceholder(t),
							o = Lt.posFromPlaceholder(this.editable);
						this.$popover.css({
							display: 'block',
		...
		ce = (function () {
			...
			return (
				(t.prototype.shouldInitialize = function () {
					return !j.isEmpty(this.options.popover.table);
				}),
				(t.prototype.initialize = function () {
					this.$popover = this.ui
					...
					this.context.invoke('buttons.build', t, this.options.popover.table),
						L.isFF && document.execCommand('enableInlineTableEditing', !1, !1);
				}),
				(t.prototype.destroy = function () {
					this.$popover.remove();
				}),
				...
				(t.prototype.createVideoNode = function (t) {
					...
					if (o && 11 === o[1].length) {
						...
						if (void 0 !== o[2]) {
							...
							if (m)
								for (var g = [3600, 60, 1], v = 0, b = g.length; v < b; v++)
						...
						e = k('<iframe>')
							...
							.attr(
								'src',
								'//www.youtube.com/embed/' + p + (0 < f ? '?start=' + f : '')
							)
							.attr('width', '640')
							.attr('height', '360');
						...
						e = k(
							...
							.attr('height', '498')
							.attr('width', '510')
							.attr('src', '//player.youku.com/embed/' + a[1]);
						...
						e = k(
							...
							.attr(
								'src',
								'http://v.qq.com/iframe/player.html?vid=' + y + '&amp;auto=0'
							);
					} else {
						if (!(d || u || h)) return !1;
						e = k('<video controls>')
		...
		ue = (function () {
			...
			return (
				...
				(t.prototype.createShortcutList = function () {
					var n = this,
						i = this.options.keyMap[L.isMac ? 'mac' : 'pc'];
					return Object.keys(i)
						.map(function (t) {
							...
							return (
								o
									.append(
										k('<label><kbd>' + t + '</kdb></label>').css({
											width: 180,
											'margin-right': 10,
										})
									)
									.append(k('<span/>').html(n.context.memo('help.' + e) || e)),
								o.html()
							);
						})
						.join('');
		...
		he = (function () {
				...
				(this.context = t),
					...
					(this.events = {
						...
						'summernote.focusout': function (t, e) {
							L.isFF ||
								(e.relatedTarget &&
									Lt.ancestor(e.relatedTarget, D.eq(o.$popover[0]))) ||
								o.hide();
						},
					});
			}
			return (
				(t.prototype.shouldInitialize = function () {
					return this.options.airMode && !j.isEmpty(this.options.popover.air);
				}),
				(t.prototype.initialize = function () {
					this.$popover = this.ui
				...
				(t.prototype.update = function () {
					...
					if (t.range && !t.range.isCollapsed()) {
						var e = j.last(t.range.getClientRects());
						if (e) {
							var o = D.rect2bnd(e);
							this.$popover.css({
								display: 'block',
		...
		pe = (function () {
			function t(t) {
				...
				(this.context = t),
					...
					(this.hints = k.isArray(this.hint) ? this.hint : [this.hint]),
					(this.events = {
						'summernote.keyup': function (t, e) {
							e.isDefaultPrevented() || o.handleKeyup(e);
						},
			...
			return (
					...
					(this.lastWordRange = null),
						...
						this.$content.on('click', '.note-hint-item', function (t) {
							e.$content.find('.active').removeClass('active'),
								k(t.currentTarget).addClass('active'),
								e.replace();
						});
				}),
				(t.prototype.destroy = function () {
				...
				(t.prototype.moveDown = function () {
					...
					if (e.length) this.selectItem(e);
						...
						var o = t.parent().next();
						o.length || (o = this.$content.find('.note-hint-group').first()),
							this.selectItem(o.find('.note-hint-item').first());
					}
				}),
				(t.prototype.moveUp = function () {
					...
					if (e.length) this.selectItem(e);
						...
						var o = t.parent().prev();
						o.length || (o = this.$content.find('.note-hint-group').last()),
							this.selectItem(o.find('.note-hint-item').last());
					}
				}),
				(t.prototype.replace = function () {
					var t = this.$content.find('.note-hint-item.active');
					if (t.length) {
						...
						this.lastWordRange.insertNode(e),
							zt.createFromNode(e).collapse().select(),
							(this.lastWordRange = null),
							this.hide(),
							this.context.triggerEvent(
								'change',
				...
				(t.prototype.nodeFromItem = function (t) {
					...
					return 'string' == typeof n && (n = Lt.createText(n)), n;
				}),
				(t.prototype.createItemTemplates = function (n, t) {
					...
					return t.map(function (t, e) {
						...
						return (
							o.append(i.template ? i.template(t) : t + ''),
							o.data({ index: n, item: t }),
							o
						);
					});
				}),
				...
				(t.prototype.createGroup = function (e, t) {
					...
					return (
						this.searchKeyword(e, t, function (t) {
							(t = t || []).length &&
								(n.html(o.createItemTemplates(e, t)), o.show());
						}),
						n
					);
				}),
				(t.prototype.handleKeyup = function (t) {
					var o = this;
					if (!j.contains([K.code.ENTER, K.code.UP, K.code.DOWN], t.keyCode)) {
						var e = this.context.invoke('editor.createRange').getWordRange(),
							n = e.toString();
						if (this.hints.length && n) {
							this.$content.empty();
							var i = D.rect2bnd(j.last(e.getClientRects()));
							i &&
								(this.$popover.hide(),
								(this.lastWordRange = e),
		...
		fe = (function () {
			...
			return (
				...
				(t.prototype.triggerEvent = function () {
					var t = j.head(arguments),
						e = j.tail(j.from(arguments)),
						o = this.options.callbacks[D.namespaceToCamel(t, 'on')];
					o && o.apply(this.$note[0], e),
						this.$note.trigger('summernote.' + t, e);
				}),
				(t.prototype.initializeModule = function (t) {
					var e = this.modules[t];
					(e.shouldInitialize = e.shouldInitialize || D.ok),
						e.shouldInitialize() &&
							(e.initialize && e.initialize(),
							e.events && Lt.attachEvents(this.$note, e.events));
				}),
				...
				(t.prototype.removeModule = function (t) {
					var e = this.modules[t];
					e.shouldInitialize() &&
						(e.events && Lt.detachEvents(this.$note, e.events),
						e.destroy && e.destroy()),
				...
				(t.prototype.invoke = function () {
					var t = j.head(arguments),
						...
						n = 1 < o.length,
						i = n && j.head(o),
						r = n ? j.last(o) : j.head(o),
						s = this.modules[i || 'editor'];
					return !i && this[r]
						? this[r].apply(this, e)
						: s && s[r] && s.shouldInitialize()
						? s[r].apply(s, e)
						: void 0;
				}),
				t
	...
	k.fn.extend({
		summernote: function () {
			var t = k.type(j.head(arguments)),
				e = 'string' === t,
				o = 'object' === t,
				i = k.extend({}, k.summernote.options, o ? j.head(arguments) : {});
			(i.langInfo = k.extend(
				!0,
				{},
				k.summernote.lang['en-US'],
				k.summernote.lang[i.lang]
			)),
				(i.icons = k.extend(!0, {}, k.summernote.options.icons, i.icons)),
				(i.tooltip = 'auto' === i.tooltip ? !L.isSupportTouch : i.tooltip),
				this.each(function (t, e) {
					var o = k(e);
					if (!o.data('summernote')) {
						var n = new fe(o, i);
						o.data('summernote', n),
							o.data('summernote').triggerEvent('init', n.layoutInfo);
					}
				});
			var n = this.first();
			if (n.length) {
				var r = n.data('summernote');
				if (e) return r.invoke.apply(r, j.from(arguments));
