	...
	(CalendarApp.prototype.onDrop = function (eventObj, date) {
		...
		(CalendarApp.prototype.onEventClick = function (calEvent, jsEvent, view) {
			...
			form.append(
				"<div class='input-group'><input class='form-control' type=text value='" +
					calEvent.title +
					"' /><span class='input-group-append'><button type='submit' class='btn btn-success btn-md'>Save</button></span></div>"
			);
			$this.$modal.modal({
				backdrop: 'static',
			});
		...
		(CalendarApp.prototype.onSelect = function (start, end, allDay) {
			...
			form
				.find('.row')
				.append(
					"<div class='col-md-12'><div class='form-group'><label class='control-label'>Event Name</label><input class='form-control' type='text' name='title'/></div></div>"
				)
				.append(
					"<div class='col-md-12'><div class='form-group'><label class='control-label'>Category</label><select class='select form-control' name='category'></select></div></div>"
				)
