!(function (t, e) {
	...
	return (function (t) {
		...
		function (t, e, n) {
			...
			function x(t, e, n) {
				var r, i;
				for (r = 0; r < n.length; r++) if ((i = F(t, e, n[r]))) return i;
				return 0;
			}
			function F(t, e, n) {
				return n.func
					? n.func(t, e)
					: z(t[n.field], e[n.field]) * (n.order || 1);
			}
			function z(t, e) {
				return t || e
					? null == e
			...
			function A(t, n) {
				...
				for (
					...
					((i = e.unitsDesc[r]), !((o = G(i, t, n)) >= 1 && ut(o)));
					r++
				);
				return i;
			}
			...
			(e.isPrimaryMouseButton = w),
				...
				(e.divideRangeByDuration = N),
				(e.divideDurationByDuration = V),
					...
					return (
						(t.prototype.intersect = function (e) {
							...
							return (
								...
								null != e.endMs &&
									(r = null == r ? e.endMs : Math.min(r, e.endMs)),
								(null == n || null == r || n < r) &&
									((i = new t(n, r)),
					...
					return (
						...
						(e.prototype.listenTo = function (t, e, n) {
							if ('object' == typeof e)
								...
								'string' == typeof e &&
									t.on(e + '.' + this.getListenerNamespace(), i.proxy(n, this));
						}),
					...
					o.isMoment(p) || a.isNativeDate(p) || void 0 === p
						...
						: ((r = !1),
						  ...
						  r
								...
								: n && (i ? (c._ambigZone = !0) : h && c.utcOffset(p))),
					(c._fullCalendar = !0),
					c
				);
			}
					...
					return (
						(t.prototype.getAllEventRanges = function (t) {
							return t
								...
								: this.eventInstances.map(i.eventInstanceToEventRange);
						}),
						...
						(t.prototype.sliceNormalRenderRanges = function (t) {
							...
							for (e = 0; e < i.length; e++)
								(n = i[e]),
									(r = n.dateProfile.unzonedRange.intersect(t)) &&
		...
		function (t, e, n) {
			function r(t, e) {
				return (
					(!t && !e) ||
					(!(!t || !e) && t.component === e.component && i(t, e) && i(e, t))
				);
			}
			function i(t, e) {
				for (var n in t)
							...
							this.component.hitsNeeded(),
								...
								e
									? ((r = { left: s.getEvX(e), top: s.getEvY(e) }),
									  (i = r),
									  o &&
											((n = s.getOuterRect(o)), (i = s.constrainPoint(i, n))),
		...
		function (t, e, n) {
			...
			(e.populateInstanceComputableOptions = o),
				(e.getMomentLocaleData = s),
				i('en', d.englishDefaults);
		},
		function (t, e, n) {
			Object.defineProperty(e, '__esModule', { value: !0 });
			var r = n(0),
					...
					function e(e, n) {
						...
						return (
							...
							r.externalDroppingClass &&
								(r.externalDropping = new r.externalDroppingClass(r)),
							r
						);
					}
					return (
						...
						(e.prototype.canStartResize = function (t, e) {
							...
							return (
								(!o.getEvIsTouch(e) || n.isEventDefSelected(r)) &&
					...
					return (
						...
						(e.prototype.startNowIndicator = function () {
							...
							this.opt('nowIndicator') &&
								...
								(n =
									this.initialNowDate.clone().startOf(t).add(1, t) -
									this.initialNowDate),
						...
						(e.prototype.queryScroll = function () {
							var t = {};
							return (
								this.isDatesRendered && i.extend(t, this.queryDateScroll()), t
							);
						}),
						...
						(e.prototype.reportEventResize = function (t, e, n, r) {
							...
							(t.dateProfile = e.dateMutation.buildNewDateProfile(
								...
								this.triggerEventResize(t, e.dateMutation.endDelta, o, n, r);
						}),
						...
						(e.prototype.skipHiddenDays = function (t, e, n) {
							...
							for (
								var r = t.clone();
								this.isHiddenDayHash[(r.day() + (n ? e : 0) + 7) % 7];
				...
				o = (function () {
					...
					return (
						...
						(t.prototype.renderFgSegEls = function (t, e) {
							...
							if (t.length) {
								for (i = 0; i < t.length; i++)
									this.beforeFgSegHtml(t[i]), (s += this.fgSegHtml(t[i], e));
						...
						(t.prototype._getTimeText = function (t, e, n, r, i) {
							return (
								...
								this.displayEventTime && !n
									? i && e
										? this.view.formatRange({ start: t, end: e }, !1, r)
										: t.format(r)
									: ''
							);
						}),
						...
						(t.prototype.compareEventSegs = function (t, e) {
							...
							return (
								r.startMs - s.startMs ||
								s.endMs - s.startMs - (r.endMs - r.startMs) ||
					...
					return (
						...
						(e.prototype._watchDeps = function (t, e, n) {
							var r = this,
								...
								c = function (t, n, r) {
									void 0 === n
										? (r || void 0 === a[t] || s--, delete a[t])
										: (r || void 0 !== a[t] || s++, (a[t] = n)),
										--i || (s === o && (u || e(a)));
								},
								p = function (t, e) {
									r.on(t, e), l.push([t, e]);
					...
					return (
						(t.prototype.buildNewDateProfile = function (t, e) {
							...
							return (
								...
								this.dateDelta &&
									((o = !0), n.add(this.dateDelta), r && r.add(this.dateDelta)),
		...
		function (t, e, n) {
			...
			function p(t) {
				...
				for (e = 0; e < t.length; e++)
					(n = t[e]),
						n.token
							? ((r = S[n.token.charAt(0)]), i.push(r ? r.unit : 'second'))
							: n.maybe
					...
					return (
						...
						(t.prototype.queryBoundingRect = function () {
							...
							return this.els.length > 0 &&
								((t = i.getScrollParent(this.els.eq(0))), !t.is(document))
								? i.getClientRect(t)
								: null;
						}),
					...
					return (
						...
						(t.prototype.handleMove = function (t) {
							...
							this.isDistanceSurpassed ||
								(e * e + n * n >= r * r && this.handleDistanceSurpassed(t)),
							...
							(this.isAutoScroll =
								...
								this.isAutoScroll &&
									this.listenTo(
										t,
										'scroll',
										i.debounce(this.handleDebouncedScroll, 100)
									);
						}),
						...
						(t.prototype.computeScrollBounds = function () {
							this.isAutoScroll &&
								(this.scrollBounds = i.getOuterRect(this.scrollEl));
						}),
					...
					return (
						...
						(e.prototype.updateDayTable = function () {
							for (
								var t,
									...
									o = i.calendar,
									s = o.msToUtcMoment(
										r.dateProfile.renderUnzonedRange.startMs,
										!0
									),
									a = o.msToUtcMoment(
								...
								'<th class="' +
									...
									(s
										? o.buildGotoAnchorHtml(
												{ date: t, forceOff: r.rowCnt > 1 || 1 === r.colCnt },
												l
										  )
										: l) +
									'</th>'
						...
						(e.prototype.renderBgCellsHtml = function (t) {
							...
							for (e = 0; e < this.colCnt; e++)
								(n = this.getCellDate(t, e)), r.push(this.renderBgCellHtml(n));
							return r.join('');
						}),
						(e.prototype.renderBgCellHtml = function (t, e) {
							var n = this,
								...
								o = n.getDayClasses(t);
							return (
								o.unshift('fc-day', r.calendar.theme.getClass('widgetContent')),
								'<td class="' +
									o.join(' ') +
									'"' +
				...
				return (
					(t.prototype.render = function (t) {
						var e = this.component,
							...
							i = r
								? e.eventRangesToEventFootprints(r.sliceRenderRanges(n))
								: [];
					...
					return (
						...
						(e.prototype.renderMoreLink = function (t, e, n) {
							...
							return i('<a class="fc-more"/>')
								...
								.on('click', function (s) {
									...
									'function' == typeof a &&
										(a = r.publiclyTrigger('eventLimitClick', {
											context: o,
											args: [
												{
													date: l.clone(),
						...
						(e.prototype.resliceDaySegs = function (t, e) {
							...
							for (n = 0; n < t.length; n++)
								(r = t[n]),
									(o =
										r.footprint.componentFootprint.unzonedRange.intersect(c)) &&
										p.push(
											i.extend({}, r, {
						...
						(e.prototype.getCellSegs = function (t, e, n) {
							for (
								var r,
									i = this.eventRenderer.rowStructs[t].segMatrix,
									o = n || 0,
									s = [];
								o < i.length;
					...
					return (
						...
						(t.prototype.initialRender = function () {
							...
							e.addClass('fc'),
								...
								this.optionsManager.watch(
									...
									['?businessHours'],
									function (e) {
										(t.businessHourGenerator = new D.default(
											e.businessHours,
											t
										)),
											t.view &&
						...
						(t.prototype.destroy = function () {
							this.view && this.clearView(),
								...
								this.windowResizeProxy &&
									(i(window).unbind('resize', this.windowResizeProxy),
						...
						(t.prototype.renderView = function (t) {
							...
							this.freezeContentHeight(),
								...
								!this.view &&
									...
									e.startBatchRender(),
									e.setElement(
										i("<div class='fc-view fc-" + t + "-view' />").appendTo(
											this.contentEl
										)
									),
						...
						(t.prototype.initToolbars = function () {
							(this.header = new c.default(this, this.computeHeaderOptions())),
								...
								(this.toolbarsManager = new a.default([
									this.header,
									this.footer,
								]));
						}),
						...
						(t.prototype.updateToolbarButtons = function (t) {
							...
							this.toolbarsManager.proxyCall(
								r.isValid && !t.currentUnzonedRange.containsDate(e)
									? 'enableButton'
									: 'disableButton',
								'today'
							),
								this.toolbarsManager.proxyCall(
									i.isValid ? 'enableButton' : 'disableButton',
									'prev'
								),
								this.toolbarsManager.proxyCall(
						...
						(t.prototype.buildSelectFootprint = function (t, e) {
							...
							return (
								(n = e
									...
									: r.hasTime()
									? r.clone().add(this.defaultTimedEventDuration)
									: r.clone().add(this.defaultAllDayEventDuration)),
						...
						(t.prototype.moment = function () {
							...
							return (
								'local' === this.opt('timezone')
									? ((n = v.default.apply(null, t)), n.hasTime() && n.local())
									: (n =
											'UTC' === this.opt('timezone')
												? v.default.utc.apply(null, t)
												: v.default.parseZone.apply(null, t)),
						...
						(t.prototype.applyTimezone = function (t) {
							...
							return (
								r &&
									((e = n.clone().add(r)), t.time() - e.time() == 0 && (n = e)),
								n
							);
						}),
						(t.prototype.footprintToDateProfile = function (t, e) {
							var n,
								r = v.default.utc(t.unzonedRange.startMs);
							return (
								e || (n = v.default.utc(t.unzonedRange.endMs)),
								t.isAllDay
						...
						(t.prototype.removeEventSources = function (t) {
							...
							if (null == t) this.eventManager.removeAllSources();
								...
								for (
									e = r.multiQuerySources(t), r.freeze(), n = 0;
									n < e.length;
									n++
								)
									r.removeSource(e[n]);
		...
		function (t, e, n) {
			...
			function i(t, e) {
				...
				for (n = 0; n < t.length; n++) {
					if (
						((r = t[n].eventInstance), (i = r.def), !1 === (o = i.getOverlap()))
					)
						return !1;
							...
							if (d)
								for (e = 0; e < r.length; e++)
									if (
										!1 ===
										d(
											r[e].componentFootprint.toLegacy(this._calendar),
											r[e].getEventLegacy()
										)
									)
										return !1;
				...
				u = (function () {
					...
					return (
						(t.prototype.buildEventInstanceGroup = function (t, e) {
							...
							if (r.length)
								return (
									(n = new o.default(i.eventDefsToEventInstances(r, e))),
				...
				p = (function (t) {
					function e(n, r) {
						...
						return (
							...
							i.eventRendererClass &&
								(i.eventRenderer = new i.eventRendererClass(i, i.fillRenderer)),
							...
							i.businessHourRendererClass &&
								i.fillRenderer &&
								(i.businessHourRenderer = new i.businessHourRendererClass(
									i,
									i.fillRenderer
								)),
							i
					...
					return (
						...
						(e.prototype.buildGotoAnchorHtml = function (t, e, n) {
							...
							return (
								o.isPlainObject(t)
									? ((r = t.date), (i = t.type), (s = t.forceOff))
									: (r = t),
								(r = l.default(r)),
							...
							return (
								this.dateProfile.activeUnzonedRange.containsDate(t)
									? (i.push('fc-' + a.dayIDs[t.day()]),
									  r.isDateInOtherMonth(t, this.dateProfile) &&
											i.push('fc-other-month'),
									  (n = r.calendar.getNow()),
									  t.isSame(n, 'day')
											? (i.push('fc-today'),
											  !0 !== e && i.push(r.calendar.theme.getClass('today')))
											: t < n
											? i.push('fc-past')
											: i.push('fc-future'))
						...
						(e.prototype.computeDayRange = function (t) {
							var e = this._getCalendar(),
								...
								o = r.clone().stripTime();
							return (
								i && i >= this.nextDayThreshold && o.add(1, 'days'),
						...
						(t.prototype.adjustActiveRange = function (t, e, n) {
							...
							return (
								this._view.usesMinMaxTime &&
									(e < 0 && r.time(0).add(e), n > 864e5 && i.time(n - 864e5)),
								new o.default(r, i)
							);
						}),
						(t.prototype.buildRangeFromDuration = function (t, e, n, s) {
							...
							return (
								h ||
									...
									l
										? ((u = r.duration(l)),
										  (h = u < n ? i.computeDurationGreatestUnit(u, l) : s))
										: (h = s)),
								n.as('days') <= 1 &&
				...
				v = (function (t) {
					...
					return (
								...
								hitOver: function (t) {
									...
									r
										? ((i = o.computeExternalDrop(r, u)),
										  i
												? ((e = new h.default(i.buildInstances())),
												  (n = u.eventProps
						...
						(e.prototype.computeExternalDrop = function (t, e) {
							...
							return (
								t.isAllDay &&
									(e.startTime ? i.time(e.startTime) : i.stripTime()),
								e.duration && (n = i.clone().add(e.duration)),
								(i = r.applyTimezone(i)),
								n && (n = r.applyTimezone(n)),
								p.default.parse(
									o.extend({}, e.eventProps, { start: i, end: n }),
									new f.default(r)
								)
							);
						}),
						...
						(e.prototype.buildDragListener = function (t, e) {
							...
							return (this.dragListener = new l.default(s, {
								...
								hitOver: function (n, l, c) {
									...
									g && v
										? ((r = e
												? i.computeEventStartResizeMutation(g, v, t.footprint)
												: i.computeEventEndResizeMutation(g, v, t.footprint)),
										  r
												? ((h = d.buildMutatedEventInstanceGroup(p.id, r)),
				...
				c = (function (t) {
					...
					return (
						...
						(e.prototype.handleTouchStart = function (t, e) {
							...
							n.canStartDrag(t, e)
								? this.buildDragListener(t).startInteraction(e, r)
								: n.canStartSelection(t, e) &&
								  this.buildSelectListener(t).startInteraction(e, r);
						}),
							...
							var g = (this.dragListener = new l.default(a, {
								...
								hitOver: function (e, l, u) {
									...
									t.hit && (u = t.hit),
										...
										p && f
											? ((r = o.computeEventDropMutation(p, f, h)),
											  r
													? ((v = c.buildMutatedEventInstanceGroup(h.id, r)),
						...
						(e.prototype.computeEventDateMutation = function (t, e) {
							...
							return (
								t.isAllDay !== e.isAllDay &&
									((a = !0), e.isAllDay ? ((u = !0), i.stripTime()) : (l = !0)),
						...
						(e.prototype.bindToEl = function (t) {
							...
							n.bindDateHandlerToEl(t, 'mousedown', function (t) {
								...
								n.bindDateHandlerToEl(t, 'touchstart', function (t) {
									e.opt('selectable') &&
										!n.shouldIgnoreTouch() &&
										r.startInteraction(t, { delay: e.getDelay() });
								}),
							...
							return this.opt('weekNumbers')
								? ((t = r.format(this.opt('smallWeekFormat'))),
								  '<th class="fc-axis fc-week-number ' +
										...
										'>' +
										e.buildGotoAnchorHtml(
											{ date: r, type: 'week', forceOff: this.colCnt > 1 },
											u.htmlEscape(t)
										) +
										'</th>')
								: '<th class="fc-axis ' +
				...
				f = (function (t) {
					function e(e, n) {
						...
						return (
							...
							r.opt('allDaySlot') &&
								((r.dayGrid = r.instantiateDayGrid()), r.addChild(r.dayGrid)),
					...
					return (
						...
						(e.prototype.renderDrag = function (t, e, n) {
							var r = o(t),
								i = !1;
							return (
								(i = this.timeGrid.renderDrag(r.timed, e, n)),
								this.dayGrid &&
									(i = this.dayGrid.renderDrag(r.allDay, e, n) || i),
								i
							);
						}),
						(e.prototype.renderEventResize = function (t, e, n) {
			...
			var r = n(0),
				...
				u = (function (t) {
					...
					return (
						...
						(e.prototype.buildRenderRange = function (e, n, r) {
							var i,
								o = t.prototype.buildRenderRange.call(this, e, n, r),
					...
					return (
						...
						(e.prototype.renderDates = function (t) {
							for (
								var e = this.calendar,
									...
									r = e.msToUtcMoment(t.renderUnzonedRange.endMs, !0),
									i = [],
									o = [];
								n < r;
							...
							for (e = 0; e < i.length; e++)
								if (
									...
									!r.isEnd &&
										...
										e + 1 < i.length &&
										t.unzonedRange.endMs <
											i[e + 1].startMs + this.nextDayThreshold)
								) {
						...
						(e.prototype.groupSegsByDay = function (t) {
							var e,
								...
								r = [];
							for (e = 0; e < t.length; e++)
								(n = t[e]), (r[n.dayIndex] || (r[n.dayIndex] = [])).push(n);
							return r;
						}),
		...
		function (t, e, n) {
			...
			n(9),
				...
				n(96),
				n(97),
				(r.fullCalendar = r.extend(i.default, o)),
							...
							'string' == typeof t
								? 'getCalendar' === t
									...
									? r.isFunction(d[t])
										...
										: s.warn("'" + t + "' is an unknown FullCalendar method.")
									: s.warn(
		...
		function (t, e, n) {
			...
			var i = n(19);
			(r.default.defaults = i.globalDefaults),
				(r.default.englishDefaults = i.englishDefaults),
				(r.default.rtlDefaults = i.rtlDefaults);
			var o = n(2);
			(e.applyAll = o.applyAll),
				(e.debounce = o.debounce),
				(e.isInt = o.isInt),
				(e.htmlEscape = o.htmlEscape),
				(e.cssToStr = o.cssToStr),
				(e.proxy = o.proxy),
				(e.capitaliseFirstLetter = o.capitaliseFirstLetter),
				(e.getOuterRect = o.getOuterRect),
				(e.getClientRect = o.getClientRect),
				(e.getContentRect = o.getContentRect),
				(e.getScrollbarWidths = o.getScrollbarWidths),
				(e.preventDefault = o.preventDefault),
				(e.parseFieldSpecs = o.parseFieldSpecs),
				(e.compareByFieldSpecs = o.compareByFieldSpecs),
				(e.compareByFieldSpec = o.compareByFieldSpec),
				(e.flexibleCompare = o.flexibleCompare),
				(e.computeGreatestUnit = o.computeGreatestUnit),
				(e.divideRangeByDuration = o.divideRangeByDuration),
				(e.divideDurationByDuration = o.divideDurationByDuration),
				(e.multiplyDuration = o.multiplyDuration),
				(e.durationHasTime = o.durationHasTime),
				(e.log = o.log),
				(e.warn = o.warn),
				(e.removeExact = o.removeExact),
				(e.intersectRects = o.intersectRects);
			var s = n(37);
			(e.formatDate = s.formatDate),
				(e.formatRange = s.formatRange),
				(e.queryMostGranularFormatUnit = s.queryMostGranularFormatUnit);
			var a = n(20);
					...
					return (
							...
							if (-1 != i.inArray(t, s.unitsDesc))
								for (
									e = this._calendar.header.getViewsWithButtons(),
										i.each(o.default.views, function (t) {
											e.push(t);
										}),
										n = 0;
									n < e.length;
							...
							return (
								...
								!!e.class &&
									...
									i &&
										((l = r.duration(i)),
										l.valueOf() &&
											((u = s.computeDurationGreatestUnit(l, i)),
											(e.duration = l),
											(e.durationUnit = u),
											1 === l.as(u) &&
						...
						(t.prototype.buildViewSpecButtonText = function (t, e) {
							function n(n) {
								...
								return (
									r[e] ||
									(t.buttonTextKey ? r[t.buttonTextKey] : null) ||
								...
								? (r.freeze(),
								  ...
								  function () {
										...
										for (var t = 0; t < n.length; t++)
											r.removeEventDef(n[t]), i[t](), r.addEventDef(n[t]);
										r.thaw();
								  })
								: function () {};
						}),
						(t.prototype.buildMutatedEventInstanceGroup = function (t, e) {
							...
							for (n = 0; n < i.length; n++)
								(r = i[n].clone()) instanceof d.default &&
									(e.mutateSingle(r), o.push.apply(o, r.buildInstances()));
				...
				u = (function () {
					...
					return (
						...
						(t.prototype.addEventDef = function (t) {
							...
							for (
								i.push(t), this.eventDefsByUid[t.uid] = t, e = 0;
								e < o.length;
								e++
							)
					...
					return (
						(t.prototype.start = function (t) {
							this.isFollowing ||
								...
								i.getEvIsTouch(t)
									? this.listenTo(r(document), 'touchmove', this.handleMove)
									: this.listenTo(r(document), 'mousemove', this.handleMove));
						}),
								...
								r = new i.default(n, {
									...
									interactionEnd: function (r, i) {
										...
										!i &&
											...
											e.view.triggerDayClick(o, n.getHitEl(t), r);
									},
								});
							return (
								(r.shouldCancelTouchScroll = !1), (r.scrollAlwaysKills = !0), r
							);
						}),
						e
					);
		...
		function (t, e, n) {
			...
			function i(t) {
				...
				for (e = 0; e < t.length; e++)
					for (n = t[e], r = 0; r < n.length; r++)
						for (i = n[r], i.forwardSegs = [], o = e + 1; o < t.length; o++)
			...
			function o(t) {
				...
				if (void 0 === t.forwardPressure) {
					for (e = 0; e < r.length; e++)
						(n = r[e]), o(n), (i = Math.max(i, 1 + n.forwardPressure));
					t.forwardPressure = i;
				}
			}
			function s(t, e, n) {
						...
						(e.prototype.attachSegEls = function (t, e) {
							...
							return (
								'bgEvent' === t
									...
									: 'highlight' === t && (n = r.highlightContainerEls),
		...
		function (t, e, n) {
			function r(t, e) {
				var n, r;
				for (n = 0; n < e.length; n++)
					if (((r = e[n]), r.leftCol <= t.rightCol && r.rightCol >= t.leftCol))
						return !0;
				return !1;
			}
			function i(t, e) {
		...
		function (t, e, n) {
			...
			var r = n(36),
				...
				o = n(56),
				s = n(94);
			r.default.register('standard', i.default),
				r.default.register('jquery-ui', o.default),
				r.default.register('bootstrap3', s.default);
		},
		function (t, e, n) {
			Object.defineProperty(e, '__esModule', { value: !0 });
			var r = n(0),
		...
		function (t, e, n) {
			...
			(o.agenda = {
				...
				(o.agendaDay = { type: 'agenda', duration: { days: 1 } }),
				(o.agendaWeek = { type: 'agenda', duration: { weeks: 1 } });
		},
		function (t, e, n) {
			Object.defineProperty(e, '__esModule', { value: !0 });
			var r = n(7),
