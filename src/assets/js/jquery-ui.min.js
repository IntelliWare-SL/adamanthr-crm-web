 ...
 * http://jqueryui.com
 * Includes: core.js, widget.js, mouse.js, position.js, draggable.js, droppable.js, resizable.js, sortable.js, effect.js, effect-drop.js, effect-explode.js, effect-highlight.js, effect-scale.js, effect-size.js, effect-transfer.js
...
(function (t) {
	...
	function e(e, s) {
		...
		return 'area' === r
			? ((n = e.parentNode),
			  (a = n.name),
			  e.href && a && 'map' === n.nodeName.toLowerCase()
					? ((o = t("img[usemap='#" + a + "']")[0]), !!o && i(o))
					: !1)
		...
		(t.widget = function (e, i, s) {
			...
			return (
				...
				(o.prototype = t.widget.extend(
					...
					h,
					{ constructor: o, namespace: l, widgetName: e, widgetFullName: n }
				)),
				a
	...
	t(document).mouseup(function () {
						...
						? 'window' === n.containment
							? ((this.containment = [
									...
									t(window).scrollLeft() +
										...
										this.margins.left,
									t(window).scrollTop() +
										(t(window).height() || a.body.parentNode.scrollHeight) -
							...
							? ((this.containment = [
									...
									t(a).width() -
										this.helperProportions.width -
										this.margins.left,
									(t(a).height() || a.body.parentNode.scrollHeight) -
										this.helperProportions.height -
										this.margins.top,
							  ]),
							  void 0)
					...
					(a.positionAbs = s.positionAbs),
							...
							t.each(s.sortables, function () {
								return (
									...
									this !== a &&
										...
										t.contains(a.element[0], this.element[0]) &&
										(n = !1),
									n
								);
							})),
						n
							? (a.isOver ||
									...
									(a.fromOutside = s)),
							  a.currentItem && (a._mouseDrag(e), (i.position = a.position)))
							: a.isOver &&
							  ((a.isOver = 0),
		...
		t.ui.plugin.add('draggable', 'scroll', {
			...
			drag: function (e, i, s) {
				...
				o !== r && 'HTML' !== o.tagName
					? ((n.axis && 'x' === n.axis) ||
							(s.overflowOffset.top + o.offsetHeight - e.pageY <
							n.scrollSensitivity
								? (o.scrollTop = a = o.scrollTop + n.scrollSpeed)
								: e.pageY - s.overflowOffset.top < n.scrollSensitivity &&
								  (o.scrollTop = a = o.scrollTop - n.scrollSpeed)),
					  (n.axis && 'y' === n.axis) ||
							(s.overflowOffset.left + o.offsetWidth - e.pageX <
							n.scrollSensitivity
					...
					: ((n.axis && 'x' === n.axis) ||
							(e.pageY - t(r).scrollTop() < n.scrollSensitivity
								? (a = t(r).scrollTop(t(r).scrollTop() - n.scrollSpeed))
								: t(window).height() - (e.pageY - t(r).scrollTop()) <
										n.scrollSensitivity &&
								  (a = t(r).scrollTop(t(r).scrollTop() + n.scrollSpeed))),
					  (n.axis && 'y' === n.axis) ||
							(e.pageX - t(r).scrollLeft() < n.scrollSensitivity
								? (a = t(r).scrollLeft(t(r).scrollLeft() - n.scrollSpeed))
		...
		t.ui.plugin.add('draggable', 'stack', {
			start: function (e, i, s) {
				...
				o.length &&
					((n = parseInt(t(o[0]).css('zIndex'), 10) || 0),
					t(o).each(function (e) {
		...
		(t.ui.intersect = (function () {
			...
			return function (e, i, s, n) {
				...
				switch (s) {
					...
					case 'intersect':
						return (
							a + e.helperProportions.width / 2 > l &&
							c > r - e.helperProportions.width / 2 &&
							o + e.helperProportions.height / 2 > u &&
					...
					case 'touch':
						return (
							((o >= u && d >= o) || (h >= u && d >= h) || (u > o && h > d)) &&
							((a >= l && c >= a) || (r >= l && c >= r) || (l > a && r > c))
						);
					default:
						return !1;
				}
		...
		t.widget('ui.resizable', t.ui.mouse, {
			...
			_mouseStart: function (e) {
				...
				return (
					...
					a.containment &&
						((i += t(a.containment).scrollLeft() || 0),
						(s += t(a.containment).scrollTop() || 0)),
		...
		t.ui.plugin.add('resizable', 'containment', {
				...
				d &&
					...
					/document/.test(c) || c === document
						...
						: ((e = t(d)),
						  ...
						  (o = h._hasScroll(d, 'left') ? d.scrollWidth : a),
			...
			resize: function (e) {
				...
				d[0] !== document && /static/.test(d.css('position')) && (c = h),
					...
					(i = Math.abs(
						o.sizeDiff.width +
							(o._helper ? o.offset.left - c.left : o.offset.left - h.left)
					)),
					(s = Math.abs(
						o.sizeDiff.height +
			...
			resize: function (e, i) {
				...
				t(n.alsoResize).each(function () {
					var e = t(this),
						...
						n = {},
						a = e.parents(i.originalElement[0]).length
							? ['width', 'height']
			...
			resize: function () {
				...
				(s.grid = h),
					...
					/^(se|s|e)$/.test(r)
						...
						? ((i.size.width = p),
						  (i.size.height = f),
						  (i.position.top = o.top - d))
						: /^(sw)$/.test(r)
						? ((i.size.width = p),
						  (i.size.height = f),
						  (i.position.left = o.left - c))
						: ((0 >= f - u || 0 >= p - l) &&
								(e = i._getPaddingPlusBorderDimensions(this)),
						  f - u > 0
								? ((i.size.height = f), (i.position.top = o.top - d))
								: ((f = u - e.height),
								  (i.size.height = f),
								  (i.position.top = o.top + a.height - f)),
						  p - l > 0
								? ((i.size.width = p), (i.position.left = o.left - c))
								: ((p = l - e.width),
								  (i.size.width = p),
		...
		t.widget('ui.sortable', t.ui.mouse, {
								...
								? (this.overflowOffset.top +
								  ...
								  o.scrollSensitivity
										...
										: e.pageX - this.overflowOffset.left <
										  ...
										  (this.scrollParent[0].scrollLeft = r =
												this.scrollParent[0].scrollLeft - o.scrollSpeed))
								: (e.pageY - this.document.scrollTop() < o.scrollSensitivity
								  ...
								  e.pageX - this.document.scrollLeft() < o.scrollSensitivity
			...
			_getItemsAsjQuery: function (e) {
				...
				if (l && e)
					for (s = l.length - 1; s >= 0; s--)
						for (a = t(l[s], this.document[0]), n = a.length - 1; n >= 0; n--)
			...
			_refreshItems: function (e) {
				...
				for (i = c.length - 1; i >= 0; i--)
					for (o = c[i][1], r = c[i][0], s = 0, l = r.length; l > s; s++)
						(h = t(r[s])),
								...
								? (n instanceof l
										...
										: f(u, function (e, s) {
												...
												f(s.props, function (t, e) {
													...
													c[a] &&
														0 > t.inArray(null, c[a].slice(0, 3)) &&
														((c[a][3] = 1), s.from && (c._rgba = s.from(c[a])));
										  }),
								  this)
								: e
						);
		...
		(function () {
			...
			function i(e, i) {
				...
				for (s in i)
					(a = i[s]),
						e[s] !== a &&
							(n[s] || ((t.fx.step[s] || !isNaN(parseFloat(a))) && (o[s] = a)));
				return o;
			}
						...
						return function (i, s, n, a, o) {
							return 'boolean' == typeof s || void 0 === s
								? n
									...
									: e.apply(this, arguments)
								: t.effects.animateClass.call(this, { toggle: i }, s, n, a);
						};
					})(t.fn.toggleClass),
				...
				('content' === m || 'both' === m) &&
					...
					o.find('*[width]').each(function () {
						...
						f && t.effects.save(i, l),
							...
							a.from.y !== a.to.y &&
								((i.from = t.effects.setTransition(i, c, a.from.y, i.from)),
